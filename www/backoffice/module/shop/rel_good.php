...
<table border="0" width="100%" cellpadding="3" cellspacing="0" align="center">
	...
	<tr>
		<td><input type="button" value="선택상품을 등록" style="color:green" onclick="addRelGoodChecked();"> <input type="button" value="창닫기" style="color:red" onclick="parent.LayerHideRelGood();"></td>
	</tr>
	<tr>
		<td>
			<fieldset>
...
<tr height="25" align="center">
	<td><input type="checkbox" id="items[]" name="items[]" value="<?=$arrList['list'][$i]['idx']?>|<?=$arrList['list'][$i]['image_s']?>|<?=stripslashes($arrList['list'][$i]['g_name'])?>"></td>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
<tr height="25" align="center">
  <td><?=pageNavigation($arrList['total'],$scale,$pagescale,$_REQUEST[offset],"cat_no=".$_REQUEST[cat_no]."&sw=".$_REQUEST[sw]."&sk=".$_REQUEST[sk])?></td>
</tr>
</table>
