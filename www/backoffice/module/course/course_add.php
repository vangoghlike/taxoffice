...
<div id="admin-container">
	...
	<div class="admin-title-top">
		<h2 class="admin-title">코스/시설 등록</h2>
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 코스/시설관리 &nbsp;&gt;&nbsp; 코스/시설 등록</div>
	</div>
  ...
  <tbody>
	<tr>
		...
		<select name="b_type" onchange="chkType(this.value)">
			<option value="1">1. 코스 - 김유정</option>
			<option value="2">2. 코스 - 경강</option>
			<option value="3">3. 코스 - 가평</option>
			<option value="4">4. 시설 - 김유정</option>
			<option value="5">5. 시설 - 낭구마을</option>
			<option value="6">6. 시설 - 경강</option>
			<option value="7">7. 시설 - 가평</option>
		</select>
		</td>
	</tr>	
	<tr>
	...
	<tr>
		<th>제목(영문)</th>
		<td class="space-left"><input type="text" name="e_subject" style="width:50%" maxlength="200" class="input" /></td>
	</tr>
	<tr>
		<th>제목(중문)</th>
		<td class="space-left"><input type="text" name="c_subject" style="width:50%" maxlength="200" class="input" /></td>
	</tr>
	<tr>
		<th>사진</th>
...
<div class="admin-buttons">
	<div class="cen">
		<span class="btn_pack xlarge icon"><span class="refresh"></span><input type="submit" value="등록" style="font-weight:bold" /></span>
	</div>
</div>
</form>
  </div>
