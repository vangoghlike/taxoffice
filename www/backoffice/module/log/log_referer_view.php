...
<div id="admin-container">
	...
	<div class="admin-title-top">
		...
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 접속통계 &nbsp;&gt;&nbsp; 링크된 주소</div>
	</div>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	...
	<tr height="25" align="left">
		...
		<b><?=number_format($arrList["total"])?>개의 링크된 주소 : <?=number_format($arrList["total_sum"])?>회</b>
		</td>
	</tr>
	</form>
</table>
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" style="border:1px solid #dedede;">
			...
			?>
				<tr align="right">
					<td bgcolor="#EEEEEE" align="left"><a href="<?=$arrList["list"][$i]["referer"]?>" target="_blank"><?=text_cut($arrList["list"][$i]["referer"],75)?></a> </td>
					<td align="center"><?=$arrList["list"][$i]["hit"]?> </td>
					<td><?=$arrList["total_sum"]!=0?number_format(($arrList["list"][$i]["hit"]/$arrList["total_sum"])*100,2):"0"?> %</td>
					<td align="left"><table border="0" title=""><tr><td bgcolor="#CCCCCC" width="<?=$arrList["total_sum"]!=0?number_format(($arrList["list"][$i]["hit"]/$arrList["total_sum"])*200,0):"0"?>" height="10"></td></tr></table></td>
				</tr>
				<?}?>
			<?}else{?>
