...
<div id="admin-container">
	...
	<div class="admin-title-top">
		...
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 접속통계 &nbsp;&gt;&nbsp; 최초 접속 페이지</div>
	</div>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	...
	<tr height="25" align="left">
		...
		<b><?=number_format($arrList["total"])?>개의 페이지 : <?=number_format($arrList["total_sum"])?>회</b>
		</td>
	</tr>
	</form>
</table>
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" style="border:1px solid #dedede;">
			...
			?>
				<tr align="right">
					<td bgcolor="#EEEEEE" align="left"><a href="<?=$arrList["list"][$i]["page"]?>" target="_blank"><?=text_cut($arrList["list"][$i]["page"],75)?></a> </td>
