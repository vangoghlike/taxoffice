...
<div id="admin-container">
	...
	<div class="admin-title-top">
		...
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 접속통계 &nbsp;&gt;&nbsp; IP별 접속통계</div>
	</div>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	...
	<tr height="25" align="left">
		...
		<b><?=number_format($arrList["total"])?>종류 IP Address : <?=number_format($arrList["total_sum"])?>회</b>
		</td>
	</tr>
	</form>
</table>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" style="border:1px solid #dedede;">
			...
			?>
				<tr align="right">
					<td width="10%" bgcolor="#EEEEEE" align="center"><?=$arrList["list"][$i]["ip"]?> </td>
