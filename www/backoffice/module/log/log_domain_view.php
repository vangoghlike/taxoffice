...
<div id="admin-container">
	...
	<div class="admin-title-top">
		...
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 접속통계 &nbsp;&gt;&nbsp; 링크된 서버</div>
	</div>
...
<table border="0" cellpadding="0" cellspacing="1" width="100%">
	...
	<tr height="25" align="left">
		...
		<b><?=number_format($arrList["total"])?>개의 링크된 도메인 : <?=number_format($arrList["total_sum"])?>회</b>
		</td>
	</tr>
	</form>
</table>
	...
	<tr>
		...
		<table border="0" cellpadding="3" cellspacing="1" width="100%" style="border:1px solid #dedede;">
			<tr align="center" bgcolor="#EEEEEE">
				<td width="20%"><b>도메인</b></td>
				<td width="10%"><b>방문수</b></td>
				<td width="10%"><b>점유율</b></td>
				<td width="60%"><b>그래프</b></td>
			</tr>
			<?
			if($arrList["total"] > 0){
			...
			?>
				<tr align="right">
					<td width="20%" bgcolor="#EEEEEE" align="center"><a href="http://<?=$arrList["list"][$i]["domain"]?>" target="_blank"><?=$arrList["list"][$i]["domain"]?></a> </td>
					...
					<td width="60%" align="left"><table border="0" title=""><tr><td bgcolor="#CCCCCC" width="<?=$arrList["total_sum"]!=0?number_format(($arrList["list"][$i]["hit"]/$arrList["total_sum"])*200,0):"0"?>" height="10"></td></tr></table></td>
				</tr>
				<?}?>
			<?}else{?>
