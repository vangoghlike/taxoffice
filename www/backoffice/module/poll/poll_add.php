...
function append() {   
 ...
 var html1 = "<input type='text' name='answer[]' style='width:500px' maxlength='100' class='input' />";  
...
<input type="hidden" name="evnMode" value="insert">
		...
		<table class="admin-table-type1">
		  ...
		  <tbody>
			<tr>
				<th>투표제목</th>
				<td class="space-left"><input type="text" name="subject" style="width:50%" maxlength="200" class="input" /></td>
			</tr>
			<tr>
				<th>로그인사용</th>
				<td class="space-left">
				<input type="radio" name="use_login" id="loginY" value="Y"><label for="loginY">로그인후 투표가능</label> &nbsp;
				<input type="radio" name="use_login" id="loginN" value="N" checked><label for="loginN">아무나 투표가능</label>
				</td>
			</tr>
			<tr>
				<th>보이기</th>
				<td class="space-left">
				<input type="radio" name="is_show" id="showY" value="Y"><label for="showY">투표보이기</label> &nbsp;
				<input type="radio" name="is_show" id="showN" value="N" checked><label for="showN">투표숨김</label>
				</td>
			</tr>
			<tr>
				<th>시작일</th>
		...
		<div class="admin-buttons">
			<div class="cen">
				<span class="btn_pack xlarge icon"><span class="refresh"></span><input type="submit" value="투표등록" style="font-weight:bold" /></span>
			</div>
		</div>
