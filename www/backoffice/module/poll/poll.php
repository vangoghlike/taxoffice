...
//제품 리스트
$arrList = getPollList($scale, $_REQUEST[offset]);
...
<table class="admin-table-type1">
  ...
  <tbody>
	...
	<tr>
		...
		<td><a href="poll_result.php?idx=<?=$arrList['list'][$i]['idx']?>">보기</a></td>
		...
		<td><a href="poll_info.php?idx=<?=$arrList['list'][$i]['idx']?>"><img src="/backoffice/images/k_modify.gif" alt="수정" /></a> <a href="javascript:delPoll('<?=$arrList['list'][$i]['idx']?>');"><img src="/backoffice/images/k_delete.gif" alt="삭제" /></a></td>
	</tr>
	<?}?>
...
<form name="frmListHidden" method="post" action="poll_evn.php">
