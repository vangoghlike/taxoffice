...
<div id="admin-container">
	...
	<div class="admin-title-top">
		<h2 class="admin-title">메인이미지 수정</h2>
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 메인이미지 관리 &nbsp;&gt;&nbsp; 메인이미지 수정</div>
	</div>
...
<table class="admin-table-type1">
  ...
  <tbody>
	<tr>
		...
		<td class="space-left">
		<select name="b_type">
			<option value="1"<?=$arrInfo["list"][0]['b_type']=="1"?" selected":""?>>1. PC 메인 슬라이드 배경 이미지</option>
			<option value="2"<?=$arrInfo["list"][0]['b_type']=="2"?" selected":""?>>2. MO 메인 슬라이드 배경 이미지</option>
			<option value="3"<?=$arrInfo["list"][0]['b_type']=="3"?" selected":""?>>3. PC 영문 슬라이드 배경 이미지</option>
			<option value="4"<?=$arrInfo["list"][0]['b_type']=="4"?" selected":""?>>4. MO 영문 슬라이드 배경 이미지</option>
		</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<th>정렬순서</th>
		<td class="space-left"><input type="text" name="b_sort" size="10" maxlength="10" value="<?=$arrInfo["list"][0]['b_sort']?>" class="input" /> (숫자가 높을수록 먼저 나타남)</td>
	</tr>
  </tbody>
</table>
