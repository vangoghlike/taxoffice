...
<div id="admin-container">
	...
	<div class="admin-title-top">
		<h2 class="admin-title">메인이미지 관리</h2>
		<div class="admin-title-right">HOME &nbsp;&gt;&nbsp; 메인이미지 관리 &nbsp;&gt;&nbsp; 메인이미지 목록</div>
	</div>
...
<form name="frm" method="get" action="<?=$_SERVER['PHP_SELF']?>">
	...
	<div class="keyword">메인이미지 구분: <select name="b_type">
			...
			<option value="1"<?=$b_type=="1"?" selected":""?>>1. PC 메인 슬라이드 배경 이미지</option>
			<option value="2"<?=$b_type=="2"?" selected":""?>>2. MO 메인 슬라이드 배경 이미지</option>
			<option value="3"<?=$b_type=="3"?" selected":""?>>3. PC 영문 슬라이드 배경 이미지</option>
			<option value="4"<?=$b_type=="4"?" selected":""?>>4. MO 영문 슬라이드 배경 이미지</option>
...
<table class="admin-table-type1">
  ...
  <tbody>
  	<?$arrType = array("","메인PC","메인MO","영문PC","영문MO");?>
