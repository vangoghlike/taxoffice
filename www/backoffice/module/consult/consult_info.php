...
<table class="admin-table-type1">
  ...
  <tbody>
	<tr>
		...
		<td class="space-left">
		<select name="b_type">
			<option value="1"<?=$arrInfo["list"][0]['b_type']=="1"?" selected":""?>>1. PC 메인 슬라이드 배경 이미지 (1900px * 470px)</option>
			<option value="2"<?=$arrInfo["list"][0]['b_type']=="2"?" selected":""?>>2. MO 메인 슬라이드 배경 이미지 (640px * 406px)</option>
			<option value="3"<?=$arrInfo["list"][0]['b_type']=="1"?" selected":""?>>1. PC 영문 슬라이드 배경 이미지 (1900px * 470px)</option>
			<option value="4"<?=$arrInfo["list"][0]['b_type']=="2"?" selected":""?>>2. MO 영문 슬라이드 배경 이미지 (640px * 406px)</option>
		</select>
		</td>
	</tr>
	<tr>
