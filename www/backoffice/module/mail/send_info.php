...
<input type="hidden" name="evnMode" value="editSend">
<input type="hidden" name="idx" value="<?=$arrInfo["list"][0][idx]?>">

<table border="0" cellpadding="0" cellspacing="1" width="100%">
<tr height="25">
  <td width="50%"><b><font color="red"> 수정</font></b></td>
...
<tr height="25">
  <td align="right" bgcolor="#000000"><font color=white><b>메일 제목</b></font></td>
  <td>&nbsp;<input type="text" name="subject" style="width:400px;" value="<?=stripslashes($arrInfo["list"][0][subject])?>"></td>
</tr>
<tr><td colspan="2" height="1" bgcolor="#CCCCCC"></td></tr>
<tr height="25">
  <td align="right" bgcolor="#000000"><font color=white><b>메일 내용</b></font></td>
  <td>&nbsp;
	<?php
...
<p align="center">
<input type="submit" value="메일발송수정" style="width:100px;height:50px;color:blue;font-weight:bold"> <input type="reset" value="수정취소" style="width:100px;height:50px;color:red;font-weight:bold">
</p>
</form>
</div>
</div>
