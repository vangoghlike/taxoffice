...
<input type="hidden" name="evnMode" value="editCategory2">
...
<input type="hidden" name="cat_gubun" value="<?=$_GET["cat_gubun"]?>">
		...
		<div class="admin-buttons">
			<div class="cen">
				...
				<span class="btn_pack xlarge"><input type="button" value="현재목록" style="font-weight:bold" onclick="document.location.href='category2.php?cat_no=<?=$currCatno?>&cat_gubun=<?=$_GET["cat_gubun"]?>'" /></span>
			</div>
		</div>
