...
<div id="admin-container">
	...
	<div class="admin-title-top">
		...
		<div class="admin-search">
			...
			<input type="hidden" name="evnMode" value="createCategory3">
		...
		?>
			<tr>
				...
				<td><a href="category4.php?cat_no=<?=$arrList["list"][$i]['cat_no']?>&cat_gubun=<?=$_GET['cat_gubun']?>"><img src="./images/btn_view.gif" border=0 alt="<?=$arrList["list"][$i]['cat_name']?>"></a></td>
