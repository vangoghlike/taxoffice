...
<?######################## 기존 CSS & 페이지 구성 ######################## ST?>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="/pages/default/css/common.css?v=20250109002" />
                    ...
                    <ul class="<?=$menu_class?>">
                        ...
                        for($i=0;$i<$arrMenu['thr'][$arrTCode[1]]['total'];$i++){
                            ...
                            if($arrMenu['thr'][$arrTCode[1]][$i]['show'] != "N"){
                                echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/fdicenter/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['thr'][$arrTCode[1]][$i]['code']].'">'.$arrMenu['thr'][$arrTCode[1]][$i]['name'].'</a></li>';
                            }
                        }
                        ?>
                    </ul>
                    ...
                    <ul>
                        ...
                        for($i=0;$i<$arrMenu['for'][$arrTCode[2]]['total'];$i++){
                            ...
                            if($arrMenu['for'][$arrTCode[2]][$i]['show'] != "N"){
                                echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/fdicenter/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['for'][$arrTCode[2]][$i]['code']].'">'.$arrMenu['for'][$arrTCode[2]][$i]['name'].'</a></li>';
                            }
                        }
                        ?>
                    </ul>
            ...
            if($arrCatInfo["total"] > 0){
                if($arrCatInfo["list"][0]["cat_use_type"] == "C" && $arrCatInfo["list"][0]["cat_cont_idx"] != 0){			// 컨텐츠
                    ...
                    if($_GET["mngr_idx"] == ""){
                        ...
                        include $_SERVER['DOCUMENT_ROOT'] ."/fdicenter/counseling/counseling_mail.php";
                    }
                    ...
                    if($_GET["mngr_idx"] == ""){
                        ...
                        if($_GET["step"] == "1"){
                            include $_SERVER['DOCUMENT_ROOT'] ."/fdicenter/counseling/report_request02.php";
                        }
                    }
                }else if($arrCatInfo["list"][0]["cat_use_type"] == "Z"){		// 화상회의실
                    include $_SERVER['DOCUMENT_ROOT'] ."/counseling/zoom_video.php";
