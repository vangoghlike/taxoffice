...
<div class="subContainer subContent">
	...
	<div class="subTopInfo">
		...
		<div class="lnb">
			...
			<span>상담센터</span><span>신고 도움 서비스</span><span>양도 소득세 신고</span><span class="last"><strong>신고 의뢰</strong></span></div>
		<!-- //lnb -->
	</div>
	<!-- //subTopInfo -->
	<!-- //subTopInfo -->
	...
	<div class="contStart taxconsulting">
		...
		<div class="tabType02 suitable">
			<ul>
				<li class="menu270 on" style="width:25%"><a href="/270"><strong>신고 의뢰</strong></a></li>
	...
	<form id="frm_tax1" name="frm_tax1" method="post">
		...
		<input type="hidden" name="mngr_fax" value="" />
		<input type="hidden" name="category" value="245" />
		<input type="hidden" name="category_name" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0310-6731" data-name="0507-0310-6731" />
						</div>
					</div>
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="02-854-2120" data-name="02-854-2120" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0307-6678" data-name="0507-0307-6678" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0310-6727" data-name="0507-0310-6727" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0307-6142" data-name="0507-0307-6142" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0307-6143" data-name="0507-0307-6143" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0307-6679" data-name="0507-0307-6679" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="0507-0310-6718" data-name="0507-0310-6718" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
...
<img src="/pages/default/images/mbv/open_view.png" alt="세무사정보 보기" />
						...
						<div class="btn">
							...
							<input type="hidden" class="mngr_fax" value="" data-name="" />
						</div>
					</div>
					<div class="itemInfo mb_ver">
						<input type="hidden" class="mngr_category_txt" value="양도소득세" />
