...
if($arrPCBannerList['list']["total"] > 0){
    ...
    $pcImg[0] = "/taxcall/pub/images/main_img1.png";
}
    ...
    <div class="">
                    ...
                    for($i=0;$i<$bannerTotal;$i++){
                        ...
                        <div class="swiper-slide">
                            <a href="javascript:void(0);">
                                <?php
                                if ( $i == 0 ) {
                                    $_imgMain = '/taxcall/img/taxcall_banner_1.jpg';
                                    $_imgMainMb = '/taxcall/img/taxcall_banner_1_m.jpg';
                                } else if ( $i == 1 ) {
                                    $_imgMain = '/taxcall/img/taxcall_banner_2.jpg';
                                    $_imgMainMb = '/taxcall/img/taxcall_banner_2_m.jpg';
                                }
                                ?>
        ...
        <div class="v_quick content_wrap">
            <div class="q_slide q_pc pc_view">
                <a href="/taxcall/sub/?cat_no=1" class="q7">
                ...
                <a href="/taxcall/sub/?cat_no=11" class="q8">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>양도/증여/상속</span><br>
                        <span>신고 도움</span>
                    </div>
                </a>

                <a href="/taxcall/sub/?cat_no=54" class="q4">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>업무보수표</span>
                    </div>
                ...
                <a href="/taxcall/sub/?cat_no=70" class="q1">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>세율표</span>
                    </div>
                ...
                <a href="/taxcall/sub/?cat_no=55" class="q3">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                ...
                <a href="/taxcall/sub/?cat_no=56" class="q1">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>회사설립</span><br />
                        <span>업무의뢰</span>
...
<!--                <a href="/taxcall/sub/?cat_no=4&boardid=hanpage&mode=write" class="q3">-->
<!--                    <div class="ir_pm q_img"></div>-->
<!--                    <div class="q_txt">-->
<!--                        <span>한페이지</span><br>-->
<!--                        <span>세무상담</span>-->
<!--                    </div>-->
<!--                </a>-->
                <a href="/taxcall/sub/?cat_no=57" class="q7">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>외투기업</span><br>
                        <span>업무의뢰</span>
                ...
                <a href="/taxcall/sub/?cat_no=59" class="q8">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>세금이야기</span><br>
                    </div>
