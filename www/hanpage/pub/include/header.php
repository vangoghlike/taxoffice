...
?>
    ...
    <header>
        <div class="header_wrap">
            <h1 class="logo">
                <a href="/hanpage" class="logo_link">
                    <img class="pc_view_logo" src="/hanpage/pub/images/logo2.png" alt="세림세무법인">
                    <img class="mb_view_logo" src="/hanpage/img/hanpage_logo_txt.png" alt="세림세무법인">
                </a>
            </h1>
...
<!--					</ul>-->
<!--				</div>-->
                <div class="family_link" style="padding:0 0.5rem; box-sizing: border-box; padding:0 0.125rem; height:1.25rem; margin-right:1.875rem; min-width:7.0rem;">
                ...
                <div class="search_wrap">
                    <form name="search" action="/hanpage/sub" method="get">
				...
				<?if($_SESSION[$_SITE["DOMAIN"]]["MEMBER"]["ID"] != ""){?>
                    ...
                    <a href="/hanpage/mypage/mypage.php">마이페이지</a>
				<?}else{?>
					<a href="/hanpage/member/login.php">로그인</a>
                    <a href="/hanpage/member/join_step1.php">회원가입</a>
				<?}?>
                </div>
            </div>
        </div>
        ...
        <nav class="gnb">
            ...
            <div class="content_wrap">
                <div class="site_logo">
                    <a href="/">
                        <img src="/hanpage/img/hanpage_logo_txt.png"/>
                    </a>
                </div>
                <ul class="gnb_main">
				<?
				for($i=0;$i<$arrMenu['one']['total'];$i++){	
					if($arrMenu['one'][$i]['show']=="Y"){
						...
						echo '<a class="pc_vw '.$sel_class.'" href="/hanpage/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
                        if ( $arrMenu['two'][$tcode]['total'] > 0 && $arrMenu['two'][$tcode]['total'] != '' ) {
                            ...
                            echo '<a class="mo_vw '.$sel_class.'" href="/hanpage/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
                        }
						echo '<ul class="gnb_sub">';						
						for($j=0;$j<$arrMenu['two'][$tcode]['total'];$j++){	
							if($arrMenu['two'][$tcode][$j]['show'] == "Y"){
								echo '<li><a href="/hanpage/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
							}
						}
						echo '</ul></div></li>';	
					}
