...
/* 기타 */
$siteDomain = "https://".$_SERVER['HTTP_HOST']."/mx5"; //가맹점 도메인 입력
...
var features = position + ", width=320, height=440";
	...
	****************************************************************************/ 
        ...
        myform.action = "https://mobile.inicis.com/smart/payment/";  // 통합
...
<!-- 결제방법->미사용  --><!--<input type="hidden" name="P_GOPAYMETHOD" value="CARD">-->
<!-- 요청지불수단		--><input type="hidden" name="P_INI_PAYMENT" value="CARD">
