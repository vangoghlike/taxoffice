...
<head>
    ...
    <link rel="stylesheet" href="/taxcall/pub/css/style.css?v=15">
    <link rel="stylesheet" href="/taxcall/pub/css/reactive.css?v=15">
	
	<!-- sub -->
    <script src="//kit.fontawesome.com/22fe7a24e1.js" crossorigin="anonymous"></script>
	<link rel="stylesheet" href="/taxcall/pub/css/sub.css">

    <script src="/taxcall/pub/js/jquery-3.6.0.min.js"></script>
    <script src="/taxcall/pub/js/slick.min.js"></script>
    <script src="/taxcall/pub/js/main.js?v=2"></script>
</head>
<body>