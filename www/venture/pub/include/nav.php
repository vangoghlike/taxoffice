...
<?php } ?>
    ...
    <div class="subNav_wrap">
		...
		for($j=0;$j<$arrMenu['two'][$arrTCode[0]]['total'];$j++){
			...
			echo '<li '.$navOnClass.'><a href="/taxcall/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$arrTCode[0]][$j]['code']].'">'.$arrMenu['two'][$arrTCode[0]][$j]['name'].'</a></li>';
		}
		?>      
        </ul>
    </div>
	...
	?>
		<div class="subNav_wrap">
			<ul class="sub_nav sub_tab5">
				...
				<li<?if($nav_id == 2){?> class="on"<?}?>><a href="/taxcall/mypage/mypage.php">마이페이지</a></li>
				<li<?if($nav_id == 3){?> class="on"<?}?>><a href="/taxcall/mypage/user_info.php">회원정보수정</a></li>
				<li<?if($nav_id == 4){?> class="on"<?}?>><a href="/taxcall/sub/agree.php">이용약관</a></li>
				<li<?if($nav_id == 5){?> class="on"<?}?>><a href="/taxcall/sub/policy.php">개인정보 처리방침</a></li>
			</ul>
		</div>
		<?}else{ // 로그인 전?>
		<div class="subNav_wrap">
			<ul class="sub_nav sub_tab5">
				<li<?if($nav_id == 1){?> class="on"<?}?>><a href="/taxcall/member/login.php">로그인</a></li>
				<li<?if($nav_id == 2){?> class="on"<?}?>><a href="/taxcall/member/join_step1.php">회원가입</a></li>
				<li<?if($nav_id == 3){?> class="on"<?}?>><a href="/taxcall/member/findid.php">아이디/비밀번호 찾기</a></li>
				<li<?if($nav_id == 4){?> class="on"<?}?>><a href="/taxcall/sub/agree.php">이용약관</a></li>
				<li<?if($nav_id == 5){?> class="on"<?}?>><a href="/taxcall/sub/policy.php">개인정보처리방침</a></li>
			</ul>
		</div>
		<?
		}
