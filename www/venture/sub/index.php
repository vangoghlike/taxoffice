		...
		<div class="tabType01 type ">
			...
			for($i=0;$i<$arrMenu['thr'][$arrTCode[1]]['total'];$i++){
				...
				if($arrMenu['thr'][$arrTCode[1]][$i]['show'] != "N"){
					echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/taxcall/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['thr'][$arrTCode[1]][$i]['code']].'">'.$arrMenu['thr'][$arrTCode[1]][$i]['name'].'</a></li>';
				}
			}			
			?>
			</ul>
		...
		<div class="tabType02 suitable">
			...
			for($i=0;$i<$arrMenu['for'][$arrTCode[2]]['total'];$i++){
				...
				if($arrMenu['for'][$arrTCode[2]][$i]['show'] != "N"){
					echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/taxcall/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['for'][$arrTCode[2]][$i]['code']].'">'.$arrMenu['for'][$arrTCode[2]][$i]['name'].'</a></li>';
				}
			}			
			?>			
			</ul>
	...
	if($arrCatInfo["total"] > 0){
		...
		<?
			...
			if($_GET["mngr_idx"] == ""){
				...
				include $_SERVER['DOCUMENT_ROOT'] ."/taxcall/counseling/counseling_mail.php";
			}
			...
			if($_GET["mngr_idx"] == ""){
				...
				if($_GET["step"] == "1"){
					include $_SERVER['DOCUMENT_ROOT'] ."/taxcall/counseling/report_request02.php";
				}
			}
...
<?}?>
<?######################## 기존 CSS & 페이지 구성 ######################## ED?>
<?include $_SERVER['DOCUMENT_ROOT'] . "/taxcall/pub/include/footer.php";?>