    ...
    <header>
        <div class="header_wrap">
            <div class="header_left">
                <h1 class="logo"><a href="/eng"><img src="/eng/pub/images/logo2.png" alt="selim"></a></h1>

                <div class="lang pc">
                    <a href="http://www.taxoffice.co.kr/">KOR</a>
                    <a href="http://www.etaxoffice.co.kr/eng/" class="on">ENG</a>
                </div>

                <div class="fdi_link">
                    <a href="http://www.fdihelpcenter.com/fdi_eng/" class="hd_sub_link">
                        <span>FDI Help Center</span></a>
                </div>

                <div class="family_link" style="padding:0 0.5rem; box-sizing: border-box; padding:0 0.125rem; height:1.25rem; min-width:7.25rem;">
                    <a href="/eng/sub/?cat_no=85" class="hd_sub_link">
...
<!--                        <a href="http://taxoffice2.hk-test.co.kr/eng/" target=""><li>SELIM ENGLISH</li></a>-->
...
<!--				</div>-->
				...
				<?if($_SESSION[$_SITE["DOMAIN"]]["MEMBER"]["ID"] != ""){?>
                    ...
                    <a href="/eng/mypage/user_info.php">MyPage</a>
				<?}else{?>
					<a href="/eng/member/login.php">Login</a>
                    <a href="/eng/member/join_step1.php">Register</a>
				<?}?>
                </div>
            </div>
        </div>
            ...
            <div class="content_wrap">
				...
				for($i=0;$i<$arrMenu['one']['total'];$i++){	
					if($arrMenu['one'][$i]['show']=="Y"){
						...
						echo '<a class="pc_vw '.$sel_class.'" href="/eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
						
						if($i==10) {
							echo '<a class="mo_vw '.$sel_class.'" href="/eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
						}else {
							...
							for($j=0;$j<$arrMenu['two'][$tcode]['total'];$j++){
								if($arrMenu['two'][$tcode][$j]['show'] == "Y"){
									echo '<li><a href="/eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
								}
							}
						}
        ...
        <!--<nav class="mo_gnb">
			...
			<div class="content_wrap">
				<a href="/eng/sub/?cat_no=77">상담센터</a>
				<a href="/eng/sub/?cat_no=124">회사설립지원</a>
				<a href="/eng/sub/?cat_no=134">외국인투자기업</a>
				<a href="/eng/sub/?cat_no=41">세무실무사례</a>
			</div>
        </nav>-->
    </header>
    <!-- header end -->