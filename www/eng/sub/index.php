...
<link rel="stylesheet" type="text/css" media="all" href="/pages/eng/css/common.css?v=20250218002" />
		...
		<div class="tabType01 type ">
			...
			for($i=0;$i<$arrMenu['thr'][$arrTCode[1]]['total'];$i++){
				...
				if($arrMenu['thr'][$arrTCode[1]][$i]['show'] != "N"){
					echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['thr'][$arrTCode[1]][$i]['code']].'">'.$arrMenu['thr'][$arrTCode[1]][$i]['name'].'</a></li>';
				}
			}			
			?>
			</ul>
		...
		<div class="tabType02 suitable">
			...
			for($i=0;$i<$arrMenu['for'][$arrTCode[2]]['total'];$i++){
				...
				if($arrMenu['for'][$arrTCode[2]][$i]['show'] != "N"){
					echo '<li '.$navOnClass.' style="width:'.$liWidth.'%"><a href="/eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['for'][$arrTCode[2]][$i]['code']].'">'.$arrMenu['for'][$arrTCode[2]][$i]['name'].'</a></li>';
				}
			}			
			?>			
			</ul>
...
$dblink = SetConn($_conf_db["main_db"]);
	...
	?>
			<div class="h3Wrap line">
				<h3>
                    <?php if ($_REQUEST['cat_no'] == '50' || $_REQUEST['cat_no'] == '56' || $_REQUEST['cat_no'] == '102') {?>
...
<div class="popup_iframe_wrap" style="display: none;">
	<div class="pi_area">
		...
		<iframe id="fdi_apply" class="pop_iframe" src="/pages/eng/images/pdf/fdi_apply_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_warrant" class="pop_iframe" src="/pages/eng/images/pdf/docu_en_warrant_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_wo_en" class="pop_iframe" src="/pages/eng/images/pdf/wo_en_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_wo_ch" class="pop_iframe" src="/pages/eng/images/pdf/wo_ch_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_kb_en" class="pop_iframe" src="/pages/eng/images/pdf/kb_en_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_sh_ko" class="pop_iframe" src="/pages/eng/images/pdf/sh_ko_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_sh_en" class="pop_iframe" src="/pages/eng/images/pdf/sh_en_document.pdf" style="display: none;"></iframe>
		<iframe id="docu_sh_ch" class="pop_iframe" src="/pages/eng/images/pdf/sh_ch_document.pdf" style="display: none;"></iframe>
	</div>
</div>
<script>
    $(function() {
