	...
	<div class="sub_content_wrap">
		...
		<div class="sub_content">
			<div class="title_wrap">
				<h3 class="page_title">특허 및 인증</h3>
			</div>
				...
				<div class="board_list">
					...
					?>
						<li>
							...
							<button type="button" class="btn_preview" onclick="popup.show('popPatent_<?=$arrBoardList["list"][$i]["idx"]?>');"><span>PreView</span></button>
						</li>
					<?
						}
					}
