	...
	<div class="right">
		<div class="searchArea">
			<form name="form1" method="get" action="<?=$_SERVER[PHP_SELF]?>"> 
				...
				<a href="javascript:void(0);" class="sbtn act_board_search" onclick="document.form1.submit()">搜索</a>
			</form>
		</div>
	</div>
</div>
		...
		<table class="listTable" cellpadding="0" cellspacing="0" summary="게시판입니다.">
			...
			<thead>
				<tr>
					...
					<th scope="col">Name <button class="btn_ord up" onclick="ordSort('name')"></button><button class="btn_ord down" onclick="ordSort('name desc')"></button></th>
			...
			?>
				<tr class="">
					<td class="td_num" colspan="6">无注册资料</td>
				</tr>
			<?
			}
			?>
