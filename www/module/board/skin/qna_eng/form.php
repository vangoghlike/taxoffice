...
<form id="frm_write" name="frm_write" method="post" action="/module/board/board_evn.php">
    <input type="hidden" name="evnMode" value="write">
    <input type="hidden" name="category" value="<?=$arrCatInfo["list"][0]["cat_name"]?>">
    <input type="hidden" name="sendmail" value="">
	<input type="hidden" name="mail_subject" value="[세림세무법인] 업무의뢰가 전송 되었습니다.">
	<input type="hidden" name="boardid" value="<?=$arrBoardInfo["list"][0]["boardid"]?>">
    ...
    <div class="tblType03 qna_dep_tbl" style="margin-bottom: 10px;">
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <th class="th_cont">
                        <label class="lb_cont">Contents</label>
                    </th>
        ...
        <div class="automatic_wrap clearfix">
            ...
            <div class="automatic_input_wrap">
                <div>
                    <p>Please input numbers to prevent automatic input.</p>
                    <input type="text" name="code" maxlength="6" title="Please input numbers to prevent automatic input." class="ipTxt02 req">
                </div>
            </div>
        </div>
        <!-- //자동방지 -->
		<div class="btnBbs bbNone ">
			<div class="right qna_dep_btn">
				...
				<a href="javascript:history.back();" class="act_back">Cancel</a>
			</div>
		</div>
    </div>
</form>
