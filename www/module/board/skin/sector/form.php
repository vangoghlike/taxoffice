			...
			<table>
				<tbody>
					<tr>
						<th>업종 주요글</th>
						<td colspan="3">
							<select name="etc_yn" onchange="changeCate(this.value)">
								<option value="N">일반글</option>
								<option value="Y">상단 업종 주요글</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td colspan="3">
							<div class="sector-sbj__area">
								<div class="type_y type_yn" style="display: none;">
									<ul>
										<li>
											<a>
												<tag>Ⅰ. 업종의 개요 (업종의 특성)</tag>
											</a>
										</li>
										<li>
											<a>
												<tag>Ⅱ. 회사의 설립 (설립, 인허가사항, 사업자등록)</tag>
											</a>
										</li>
										<li>
											<a>
												<tag>Ⅲ. 사업의 형태 (수입의 발생 형태)</tag>
											</a>
										</li>
										<li>
											<a>
												<tag>Ⅳ. 사업의 형태 (비용의 발생 형태)</tag>
											</a>
										</li>
										<li>
											<a>
									...
									<div class="sector-num__area">
										<label for="depth">업종 상단글 순서&nbsp;</label>
										<input type="number" id="depth" name="depth" class="sector_num" min="1" max="16"  value="0">
									</div>
								</div>
