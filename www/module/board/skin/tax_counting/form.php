...
<div id="admin-content">
	...
	<?endif;?>
	<?foreach ($arrBoardArticle["list"][0] as $key => $value){?>
					...
					<tr>
						...
						<td>
							<select name="etc_2" id="etc_2">
								<option>--- 선택 ---</option>
								<option value="four_insurance">인사급여</option>
								<option value="disadvantage">부가세</option>
								<option value="establishment">소득세</option>
								<option value="nationalTax_foreign">법인세</option>
								<option value="taxInfo_stock">양도세</option>
								<option value="info_dissatisfaction">상속증여</option>
								<option value="taxes">지방세</option>
								<option value="taxspecial">감면세제</option>
								<option value="tcbc2_11">주식관련</option>
								<option value="019">비영리</option>
								<option value="enter_standard03">회계실무</option>
							</select>
						</td>
					</tr>
					<tr>
