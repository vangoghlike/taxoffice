...
if($arrBoardInfo["list"][0]["useadminonly"] !="Y" || $_SESSION[$_SITE["DOMAIN"]]["ADMIN"]["ID"]):
    ...
    echo $_SESSION[$GLOBALS["_SITE"]["DOMAIN"]]["MEMBER"]["ID"];
...
<form name="form1" method="post" action="/module/board/board_evn.php">
  <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
	...
	<input type="hidden" name="returnURL" value="<?=$_SERVER[PHP_SELF]?>?cat_no=<?=$_GET["cat_no"]?>&boardid=<?=$arrBoardInfo["list"][0]["boardid"]?>&mode=modify&type=write&idx=<?=$_REQUEST["idx"]?>&category=<?=$_GET[category]?>">
	...
	<tr>
		...
		<input type="image" src="<?=$_SITE["BOARD_SKIN_URL"]?>/<?=$arrBoardInfo["list"][0]["skin"]?>/images/btn_save.jpg" align="absmiddle"  border="0"></td>
	</tr>
	<?}?>
</table>
</form>
