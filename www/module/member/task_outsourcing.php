...
<!--    <a class="mem_href twoLine btn_counsel tax"><strong>회계업무<br>의뢰신청</strong><span>--><?php //=$_managerInfoSecond['mngr_name']?><!--</span></a>-->
    <a class="mem_href twoLine btn_counsel pay"><strong>의뢰신청</strong><span><?=$_managerInfoFirst['mngr_name']?></span></a>
...
<!--            <div class="tit01">(회계업무 아웃소싱)</div>-->
        <?php } ?>
        <ul class="managerTab <?=$_this_tab_cnt?> <?=$i==0?'pay':'tax'?> mt10 mb10">
            <?php
