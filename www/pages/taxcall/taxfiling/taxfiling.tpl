...
{*{ #c_subtop }*}
        ...
        <div class="subContainer subContent">
            ...
            <div class="contStart">
                ...
                <div class="tabType01 cslType">
                    <ul>
                        <li class="menu { ? TF_TYPE == '전화상담' }on{ / }" style="width:33.3%"><a href="?tp=call"><i class="fa fa-phone"></i>&nbsp;&nbsp;전화상담<br class="pcNoBr"/>(Tax Callcenter)</a></li>
                        <li class="menu { ? TF_TYPE == '메일상담' }on{ / }" style="width:33.3%"><a href="?tp=mail"><i class="fa fa-envelope"></i>&nbsp;&nbsp;메일상담<br class="pcNoBr"/>(Tax e-Mail)</a></li>
                        <li class="menu { ? TF_TYPE == '방문상담' }on{ / }" style="width:33.3%"><a href="?tp=visit"><i class="fa fa-user"></i>&nbsp;&nbsp;방문상담<br class="pcNoBr"/>(예약센터)</a></li>
{*                        <li class="menu220" style="width:25%"><a href="/220">세무상담 Hub</a></li>*}
                    </ul>
                </div>
            </div>
            ...
            <div class="telTab">
                { ? TF_TYPE != '방문상담' }
                <ul class="threeTab">
                    <li{ ? STEP == '1' } class="active"{ / }><a>세무사 선정</a></li>
                    <li{ ? STEP == '2' } class="active"{ / }><a>{ TF_TYPE }</a></li>
                    <li class="helpTab"><a>세무상담 Hub</a></li>
                </ul>
                { : }
                <ul class="fourTab">
                    <li{ ? STEP == '1' } class="active"{ / }><a>세무사 선정</a></li>
                    <li{ ? STEP == '2' } class="active"{ / }><a>상담일정 선택</a></li>
                    <li{ ? STEP == '3' } class="active"{ / }><a>{ TF_TYPE }</a></li>
                    <li class="helpTab"><a>세무상담 Hub</a></li>
                </ul>
                { / }
            </div>
...
{ ? STEP == '1' }
	        ...
	        <form id="frm_tax1" name="frm_tax1" method="post" >
	            ...
	            <input type="hidden" name="category" value="{ TF_CATEGORY_NO }" />
	            <input type="hidden" name="category_name" value="{ TF_CATEGORY_NAME }" />
...
{ ? STEP == '2' }
        ...
        <div class="telTit pt30">
            ...
            <div class="tit02">{ REQ.mngr_name }<br><br>
                <tag class="white">신고의뢰</tag><tag>{ TF_CATEGORY_NAME }</tag>
            </div>
        </div>

        <form id="frm_counsel" name="frm_tax1" method="post" >
            <input type="hidden" name="step" value="3" />
            <input type="hidden" name="goods_idno" value="2" />
                    ...
                    <li class="actMb">
                        <div class="topInfo">
                            <div class="selView">
                                ...
                                <div class="txt">
                                    <div class="tit01"><a href="tel:{ REQ.mngr_phone }"><span>{ TF_CATEGORY_NAME }</span><br class="pcNo"> <tag><b>즉시통화</b> <i class="fa fa-phone" aria-hidden="true"></i></tag></a></div>
                                </div>
                            </div>
                            <div class="btn">
                    ...
                    <li>
                        <div class="topInfo">
                            <div class="selView">
                                ...
                                <div class="txt">
                                    <div class="tit01"><a class="counselGo" href="#goTalkPop"><span>{ TF_CATEGORY_NAME }</span><br class="pcNo"> <tag><b>상담예약</b> (예약후 1시간내 전화 연결) <i class="fa fa-phone" aria-hidden="true"></i></tag></a></div>
                                </div>
                            </div>
                            <div class="btn">
                                {*									<input type="radio" name="option" id="point{ .idno }" value="{ .idno }" data-name="{ .option_name }" /> <label for="point{ .idno }">선택</label>*}
        ...
        <div id="goTalkPop" class="goTalkPop">
            ...
            <form id="frm_counsel_talk" name="frm_counsel_talk" method="post" >
                ...
                <input type="hidden" name="category" value="{ TF_CATEGORY_NAME }" />
                <input type="hidden" id="loginChk" value="chk"/>
                <input type="hidden" name="goods_name" value="[신고의뢰]전화상담" />
                <div class="gtp-wrap">
                    <p><strong>상담사</strong><span>{ REQ.mngr_name }</span></p>
                    <p><strong>상담과목</strong><span>{ TF_CATEGORY_NAME }</span></p>
        ...
        <form id="frm_counsel" name="frm_tax_pay" method="post" >
            ...
            <input type="hidden" name="goods_idno" value="2" />
            <input type="hidden" name="selimbiz" value="OnBizTax" />
            <input type="hidden" name="goods_name" value="[신고의뢰]메일상담" />
            <input type="hidden" name="category_idno" value="{ TF_CATEGORY_NO }" />
            <input type="hidden" name="category_name" value="{ TF_CATEGORY_NAME }" />
            <input type="hidden" name="etc01" value="{ TF_TYPE }" />
        ...
        <form id="frm_tax1" name="frm_tax1" method="post" >
            ...
            <div class="telSca">
                ...
                <div class="line dtBox seCst">
                    ...
                    <label>
                        <img src="{ TYPE_URL }/images/mbv/bgSort.png"/>&nbsp;&nbsp;상담세목 : { TF_CATEGORY_NAME }
                    </label>
                </div>
...
{ ? STEP == '3' }
		...
		<form id="frm_counsel" name="frm_tax_pay" method="post" >
            ...
            <input type="hidden" name="pay_status" value="1" />
            <input type="hidden" name="goods_idno" value="2" />
            <input type="hidden" name="goods_name" value="[신고의뢰]방문상담" />
            <input type="hidden" name="selimbiz" value="OnBizTax" />
            <input type="hidden" name="category_idno" value="{ TF_CATEGORY_NO }" />
            <input type="hidden" name="category_name" value="{ TF_CATEGORY_NAME }" />
            <input type="hidden" name="etc01" value="{ TF_TYPE }" />
