				...
				{ @GOODS['option'] }
					<li>
						<div class="topInfo">
							<div class="selView">
								<div class="img">
									<img src="{ TYPE_URL }/images/pay/bgnewpay.png" alt="보수결제{ .price }">
								</div>
								<div class="txt">
				...
				{ / }
					<li>
						<div class="topInfo">
							<div class="selView">
								<div class="img">
									<img src="{ TYPE_URL }/images/pay/bgnewpay.png" alt="보수결제">&nbsp;&nbsp;<input class="point_txt_filed" type="number" value="" placeholder="금액입력"/>
								</div>
