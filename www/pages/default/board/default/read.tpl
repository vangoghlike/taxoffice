...
{ CONTENTS['head_contents'] }
					...
					<div class="viewWrap { DATA['board_code'] }">
						<div class="line">
							<div class="left">
								<div class="box">
						...
						{ ? DATA['editor_yn'] == 'Y' }{ DATA['contents'] }{ : }{ =nl2br(DATA['contents']) }{ / }
							...
							<div id="sns_share">
								...
								<div id="sns_list">
									...
									encodeURIComponent( (window.location.protocol) +'//'+ (window.location.hostname) + (window.location.pathname) + '?idno=' + getParameterByName('idno')  )+
									'&title='+encodeURIComponent(document.title), 'naversharedialog', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank" alt="Share on Naver" ><img src="{TYPE_URL}/images/common/naver.png"></a>
						...
						{ ? DATA['kl_status'] != NULL && DATA['kl_reply'] != '' }
					...
					<div class="btnBbs bbNone ">
						...
						<div class="right">
							{ ? CAN_WRITE == 'Y' && (CONF['auth_write'] == 'N' || DATA['reg_user_id'] == USERINFO['user_id'] || USERINFO['user_id'] == 'admin') }
