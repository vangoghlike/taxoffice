							...
							<table cellpadding="0" cellspacing="0" summary="게시판입니다.">
								...
								<thead>
									<tr>
										...
										{ ? CONF['board_code'] == 'faq' }<th>카테고리</th>{ / }
								...
								{ @ LIST }
									<tr class="{ ? .notice_yn == 'Y' }notice { / }{ ? .lev > 0 }answer { / }">
										...
										{ ? CONF['board_code'] == 'faq' }
										<td class="cate_td">
											{ ? .sub_board_code == 'four_insurance' }
											<a href="/168" target="_self">
												인사급여
											</a>
											{ : .sub_board_code == 'disadvantage' }
											<a href="/173" target="_self">
												부가세
											</a>
											{ : .sub_board_code == 'establishment' }
											<a href="/176" target="_self">
												소득세
											</a>
											{ : .sub_board_code == 'nationalTax_foreign' }
											<a href="/177" target="_self">
												법인세
											</a>
											{ : .sub_board_code == 'taxInfo_stock' }
											<a href="/179" target="_self">
												양도세
											</a>
											{ : .sub_board_code == 'info_dissatisfaction' }
											<a href="/178" target="_self">
												상속증여
											</a>
											{ : .sub_board_code == 'taxes' }
											<a href="/184" target="_self">
												지방세
											</a>
											{ : .sub_board_code == 'taxspecial' }
											<a href="/379" target="_self">
												감면세제
											</a>
											{ : .sub_board_code == 'tcbc2_11' }
											<a href="/186" target="_self">
												주식관련
											</a>
											{ : .sub_board_code == '019' }
											<a href="/204" target="_self">
												비영리
											</a>
											{ : .sub_board_code == 'sub_board_code' }
											<a href="/172" target="_self">
												회계실무
											</a>
											{ / }
										</td>
