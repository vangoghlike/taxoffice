...
<div class="subTop company mbv">
	<div class="text">세금에 대하여 궁금하시면 무엇이든 물어보세요<br>
    세림의 세무사가 여러분의 궁금증을 해결해드릴 것입니다.</div>
</div>
<!-- //subTop -->
	<!-- Wrap -->
	...
	<div class="wrap mbv">
        <div class="subNav subNavType2 sixTab">
            <ul>
                <li class="menu210 on"><a href="/counsel?tp=call">상담 센터</a></li>
                <li class="menu86"><a href="/252">신고 도움 서비스</a></li>
                <li class="menu320"><a href="/355">세금 달력</a></li>
                <li class="menu320"><a href="/330">재산 제세 실무 안내</a></li>
                <li class="menu320"><a href="/329">세무 실무 소개</a></li>
                <li class="menu86"><a href="/86">세금이야기</a></li>
		...
		<div class="subContainer subContent">
            ...
            <div class="subTopInfo">
                ...
                <div class="lnb">
                    ...
                    <span>상담 센터</span><span class="last"><?php echo $counsel_txt; ?></span></div>
                <!-- //lnb -->
            </div>
            ...
            <div class="contStart">
                <div class="tabType01 cslType">
                    <ul>
                        <li class="menu <?php if($counsel_type == 'call') echo 'on'; ?>" style="width:33.3%"><a href="/counsel?tp=call"><i class="fa fa-phone"></i>&nbsp;&nbsp;전화상담(Tax Callcenter)</a></li>
                        <li class="menu <?php if($counsel_type == 'mail') echo 'on'; ?>" style="width:33.3%"><a href="/counsel?tp=mail"><i class="fa fa-envelope"></i>&nbsp;&nbsp;메일상담(Tax e-Mail)</a></li>
                        <li class="menu <?php if($counsel_type == 'visit') echo 'on'; ?>" style="width:33.3%"><a href="/counsel?tp=visit"><i class="fa fa-user"></i>&nbsp;&nbsp;방문상담(예약센터)</a></li>
