            ...
            <div id="mailconts">
                ...
                <div id="mailconts_right">
                    <table class="base01 sendmail">
                        ...
                        <tr>
                            <td>
                                <a href="./{ CONTENTS['menu_idno'] }?type={ .goods_idno }&idno={ .idno }&page={ PAGE }">{ .goods_name }</a>
                            </td>
                            <td>
                                <a href="./{ CONTENTS['menu_idno'] }?type={ .goods_idno }&idno={ .idno }&page={ PAGE }">{ .category_name }</a>
                            </td>
                            <td>
                                <a href="./{ CONTENTS['menu_idno'] }?type={ .goods_idno }&idno={ .idno }&page={ PAGE }">{ .user_name }</a>
                            </td>
                            <td>
                                <a href="./{ CONTENTS['menu_idno'] }?type={ .goods_idno }&idno={ .idno }&page={ PAGE }">{ .reg_date }</a>
                            </td>
                            <td style="text-align: center;">
                                ...
                                class="kakao_no_tag kakao_tag"
                                    { / }
                                href="./{ CONTENTS['menu_idno'] }?type={ .goods_idno }&idno={ .idno }&page={ PAGE }">{ .send_kakao_yn }</a>
                                { / }
                            </td>
