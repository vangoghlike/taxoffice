...
{*						      <col>*}
						  ...
						  { : }
							...
							<td>
							    <input id="newid" type="text" name="user_id" size="49" class="req" value="" maxlength="16" placeholder="영문/숫자 조합 6~16자" data-pattern="id" data-minlen="6" required="required"/>
						  ...
						  { / }
							...
							<td>
							    <input id="newpw" type="password" name="passwd" size="49" value="" maxlength="12" placeholder="영문/숫자 조합 포함 4~12자 이내" data-pattern="wordnum" data-minlen="4"{ ? !USER['user_id'] } class="req" required="required"{ / }/>{ ? USER['user_id'] } (변경 시 입력){ / }
							</td>
						    </tr>
						    <tr>
							<th>
							...
							<td>
							    <input id="newpw2" type="password" name="passwd_conf" size="49" value="" maxlength="12" placeholder="영문/숫자 조합 포함 4~12자 이내"{ ? !USER['user_id'] } class="req" required="required"{ / }/>
							</td>
						    </tr>
						  { ? USER['user_id'] }
						      <tr>
