...
{ #subtop }
		...
		<div class="subTop company tax_cs">
...
{*            <div style="line-height:1.6; padding:1.0rem 3.0rem 2.0rem; background:#eaeaea; border-radius:1.0rem; margin:2.0rem auto;">*}
                    ...
                    <ul class="consulting_list">
                        ...
                        <li class="consulting_1li">
                            <div class="topInfo">
                                <div class="selView">
                                    <div class="img">
                                        <img width="200" height="254" src="{ MNGR_PHOTO_URL }{ .file_name }" alt="{ .mngr_name }">
                                    </div>
                                    <div class="txt">
                                        ...
                                        <li>
                                            <div class="txt">
                                                ...
                                                <a class="counselGoZoom consultingBtn" href="{ .cs_zoom_url }" target="_blank">
                                                    <img width="24" height="24" style="margin:0 auto;display:block; max-width:1.5rem;" src="{ TYPE_URL }/images/ico/zoom_icon.png"/>
                                                    <tag><b>화상상담</b></tag>
                                                </a>
                                                { : }
        ...
        <form id="frm_tax1" name="frm_tax1" method="post" >
            ...
            <div class="telSca">
                ...
                <div class="line dtBox seCst">
                    ...
                    <label>
                        <img src="{ TYPE_URL }/images/consulting/bgSort.png"/>&nbsp;&nbsp;상담세목 : { REQ.category_name }
                    </label>
                </div>
...
{ #footer }
    ...
    { ? !USERINFO['user_id'] }
    <div id="csl_deepBg" style="display:none;">
