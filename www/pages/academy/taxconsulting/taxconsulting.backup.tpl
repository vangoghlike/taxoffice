                ...
                <div class="teslList2 consulting">
                    <ul class="consulting_list">
                        ...
                        <li class="consulting_1li">
                            ...
                            <div class="itemInfo">
                                <p class="mb10 tac tcs_title">
                                    <a>
                                        상담가능 세목
                                    </a>
                                </p>

                                <ul class="category_li tcs hidn">
                                    { @.mngr_category_arr2 }
                                    <li class="cate_list">
                                        <label>
                                            <input type="hidden" name="tcs_goods_category" value="{ ..value_ }" data-idno="{ ..key_ }" class="tcs_goods_category">
                                            <a>
                                                { ..value_ }
                                            </a>
                                        </label>
                                ...
                                <div class="consulting_btn">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="txt">
                                                <a class="counselGoFiling consultingBtn act_submit" href="#goTcsPop">
            ...
            <form id="frm_tax1" name="frm_tax1" method="post" >
                ...
                <div class="telSca">
                    ...
                    <div class="line dtBox seCst">
                        ...
                        <label>
                            <img src="{ TYPE_URL }/images/mbv/bgSort.png"/>&nbsp;&nbsp;신고의뢰 : { REQ.category_name }
                        </label>
                    </div>
