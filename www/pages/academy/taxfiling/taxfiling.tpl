        ...
        <div class="subContainer subContent">
            ...
            <div class="contStart">
                ...
                <div class="tabType01 cslType">
                    <ul>
                        <li class="menu { ? TF_TYPE == '전화상담' }on{ / }" style="width:33.3%"><a href="?tp=call"><i class="fa fa-phone"></i>&nbsp;&nbsp;전화상담(Tax Callcenter)</a></li>
                        <li class="menu { ? TF_TYPE == '메일상담' }on{ / }" style="width:33.3%"><a href="?tp=mail"><i class="fa fa-envelope"></i>&nbsp;&nbsp;메일상담(Tax e-Mail)</a></li>
                        <li class="menu { ? TF_TYPE == '방문상담' }on{ / }" style="width:33.3%"><a href="?tp=visit"><i class="fa fa-user"></i>&nbsp;&nbsp;방문상담(예약센터)</a></li>
                    ...
                    <li class="actMb">
                        <div class="topInfo">
                            <div class="selView">
                                ...
                                <div class="txt">
                                    <div class="tit01"><a href="tel:{ REQ.mngr_tel }"><span>{ TF_CATEGORY_NAME }</span><br class="pcNo"> <tag><b>즉시통화</b> <i class="fa fa-phone" aria-hidden="true"></i></tag></a></div>
                                </div>
                            </div>
                            <div class="btn">
