{ #header }
<link rel="stylesheet" type="text/css" href="/pages/taxjob/taxjob/assets/css/taxjob_con.css"  media="all" />
<!-- Container -->
<div class="container" id="container">
    ...
    <div class="subContent">
        ...
        <div class="contStart">
            ...
            <form id="resume_form" name="resume_form" method="post" class="tj_user">
                <input type="hidden" name="act" value="tj_user_write">
                <input type="hidden" name="template_cd" value="1" id="template_cd">
                <input type="hidden" name="mode" value="" id="mode">
                <input type="hidden" name="write_mode" value="insert" id="write_mode">
                <input type="hidden" name="save_mode" value="auto_save" id="save_mode">
                <input type="hidden" name="incomplete_cd" value="0" id="incomplete_cd">
                <input type="hidden" name="save_common_available_fl" value="n" id="save_common_available_fl">
                <input type="hidden" name="complete_status" value="n" data-saved_value="n" id="complete_status">
                <input type="hidden" name="before_complete_status" value="n" data-saved_value="n" id="before_complete_status">
                ...
                <div id="resume_title" class="resume_section">
                    ...
                    <div class="resume_title">
                        <div class="resume_input">
                            <label for="title" class="bar_title">이력서 제목<span class="valid_hidden">을 입력하세요 (100자까지 입력가능)</span></label>
                            <input type="text" id="title" name="cont_title" class="resume_title_input" value="" maxlength="100" data-placeholder_empty="이력서 제목<span class='valid_hidden'>을 입력하세요 (100자까지 입력가능)</span>" data-placeholder_title="이력서 제목">
                    ...
                    <div class="resume_write resume_basic">
                        <div class="resume_row">
                            ...
                            <div class="resume_input focus">
                                ...
                                <input type="text" id="user_nm" name="user_name" class="box_input" value="{ USERINFO['user_name'] }" maxlength="20" data-only-word="true">
                                <p class="txt_error">
                                </p>
                            </div>
                            ...
                            <div class="sri_select resume_select resume_right">
                                ...
                                <input type="hidden" name="user_state" id="jobhunting_st" value="">
                                <ul class="list_opt">
...
{*                                <label for="birth_dt" class="bar_title "><span class="valid_hidden">YYYYMMDD</span><span class="blind">생년월일</span></label>*}
                                <input type="date" id="birth_dt" name="user_birth" value="" class="box_input expect_date" data-dateformat="yymmdd" data-only-number="true" autocomplete="off">
                                <p class="txt_error"></p>
                            </div>

                            <div class="inpRdoSw sizeXL resume_right">
                                <span class="inOption">
                                    <input name="user_gender" id="male" type="radio" value="male">
                                    <label for="male" class="lbl">남</label>
                                </span>
                                <span class="inOption">
                                    <input name="user_gender" id="female" type="radio" value="female">
                        ...
                        <div class="resume_row">
                            ...
                            <div class="resume_input">
                                ...
                                <input type="text" id="email" name="user_email" class="box_input max_length" value="{ USERINFO['user_email'] }" data-api_type="layer" data-api_id="basic_confirm_email">
                                <p class="txt_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="resume_row">
                            ...
                            <div class="resume_input">
                                <label for="user_phone" class="bar_title">휴대폰 번호<span class="valid_hidden"> 입력</span></label>
                                <input type="text" id="user_phone" name="user_phone" class="box_input max_length" value="{ USERINFO['user_phone'] }" maxlength="11" data-only-number="true" data-api_type="layer" data-api_id="basic_confirm_cell" >
                                <p class="txt_error"></p>
                            </div>
                        </div>
                        ...
                        <div class="resume_row">
                            ...
                            <div class="resume_address">
                                <div class="resume_input" style="display:block">
                                    ...
                                    <input type="text" id="post_code" name="user_postcode" value="" maxlength="40" readonly="" class="box_input post_code _searchArea">
                                    <p class="txt_error"></p>
                                </div>
                                ...
                                <div class="resume_input resume_bottom" style="display:block">
                                    ...
                                    <input type="text" id="new_address" name="user_addr1" value="" maxlength="40" readonly="" class="box_input old_address _searchArea">
                                    <p class="txt_error"></p>
                                </div>
                                ...
                                <div class="resume_input resume_bottom" style="display:block;">
                                    ...
                                    <input type="text" id="new_address_details" name="user_addr2" value="" maxlength="50" class="box_input size_type5 _newAddress">
...
{*                        </div>*}
                ...
                <div id="add_info" class="resume_section">
                    ...
                    <div class="resume_write resume_add_info">
                        <div class="resume_row">
                            ...
                            <div class="resume_radio">
                                <label class="sri_check sri_radio" for="amiyes">
                                    <input name="user_military" class="inp_check" id="amiyes" type="radio" value="1">
                                    <span class="txt_check">군필</span>
                                </label>
                                <label class="sri_check sri_radio" for="amino">
                                    <input name="user_military" class="inp_check" id="amino" type="radio" value="2">
                        ...
                        <div class="resume_row">
                            <div class="input_title">취미 / 특기</div>
                            <div class="resume_input">
                                <label for="user_hobby" class="bar_title">취미/특기<span class="valid_hidden"> 입력</span></label>
                                <input type="text" id="user_hobby" name="user_hobby" class="box_input" value="" maxlength="80" data-only-word="true">

                            </div>
                        </div>

                        <div class="resume_row">
                            <div class="input_title">종교</div>
                            <div class="resume_input">
                                <label for="user_religion" class="bar_title">종교<span class="valid_hidden"> 입력</span></label>
                                <input type="text" id="user_religion" name="user_religion" class="box_input" value="" maxlength="80" data-only-word="true">
...
{*                        </div>*}
                        ...
                        <div class="select_title">
                            <div class="resume_radio">
                                <label class="sri_check sri_radio" for="school_type_primary">
                                    <input name="user_education" class="inp_check" id="school_type_primary" type="radio" value="primary">
                                    <span class="txt_check">초등학교 졸업</span>
                                </label>
                                <label class="sri_check sri_radio" for="school_type_middle">
                                    <input name="user_education" class="inp_check" id="school_type_middle" type="radio" value="middle">
                                    <span class="txt_check">중학교 졸업</span>
                                </label>
                                <label class="sri_check sri_radio" for="school_type_high">
                                    <input name="user_education" class="inp_check" id="school_type_high" type="radio" value="high">
                                    <span class="txt_check">고등학교 졸업</span>
                                </label>
                                <label class="sri_check sri_radio" for="school_type_univ">
                                    <input name="user_education" class="inp_check" id="school_type_univ" type="radio" value="univ">
                ...
                <div id="career" class="resume_section">
                    <input type="hidden" id="career_contents_type" name="career_contents_type" value="style">
                    <input type="hidden" id="exchange_usd" name="exchange_usd" value="1180.5">
                    <input type="hidden" id="exchange_jpy" name="exchange_jpy" value="1120.07">
...
{*                        </div>*}
                    ...
                    <div class="resume_write resume_career">
                        <div class="select_title">
                            <div class="resume_radio">
                                <label class="sri_check sri_radio" for="career_cd_1">
                                    <input name="user_career" class="inp_check" id="career_cd_1" type="radio" value="1">
                                    <span class="txt_check">신입</span>
                                </label>
                                <label class="sri_check sri_radio" for="career_cd_2">
                                    <input name="user_career" class="inp_check" id="career_cd_2" type="radio" value="2">
                        ...
                        <div id="career_template" style="display:none">
                            ...
                            <div id="tpl_row_1600236584" class="tpl_row" data-tpl_id="tpl_career_item">
                                <input type="hidden" id="career_mcom_id_1600236584" name="career_mcom_idx[]" value="">
                                <input type="hidden" id="career_com_idx_1600236584" name="career_com_idx[]" value="">
                                <input type="hidden" id="career_csn1_1600236584" name="career_csn1[]" value="">
                                <input type="hidden" id="career_csn2_1600236584" name="career_csn2[]" value="">
                                <input type="hidden" id="career_csn3_1600236584" name="career_csn3[]" value="">
                                <input type="hidden" id="career_job_category_cd_1600236584" name="career_job_category_cd[]" value="">
                                <input type="hidden" id="career_start_year_1600236584" name="career_start_year[]" value="">
                                <input type="hidden" id="career_start_month_1600236584" name="career_start_month[]" value="">
                                <input type="hidden" id="career_end_year_1600236584" name="career_end_year[]" value="">
                                <input type="hidden" id="career_end_month_1600236584" name="career_end_month[]" value="">
                                <input type="hidden" id="career_total_month_1600236584" name="career_total_month[]">
                                <input type="hidden" id="career_job_grade_1600236584" name="career_job_grade[]" value="">
                                <input type="hidden" id="career_job_duties_1600236584" name="career_job_duties[]" value="">
                                <input type="hidden" id="career_job_text_input_1600236584" name="career_job_text_input[]" value="">
                                <input type="hidden" id="career_comnm_open_fl_1600236584" name="career_comnm_open_fl[]" value="">

                                <input type="hidden" id="career_seq_1600236584" name="career_seq[]">
                                <input type="hidden" id="profilecareer_seq_1600236584" name="profilecareer_seq[]" value="">

                                <div class="resume_row">
                                    <div class="input_title">회사명 <span class="point">필수</span></div>
                                    <div class="resume_input">
                                        <label for="career_company_nm_1600236584" class="bar_title">회사명<span class="valid_hidden"> 입력</span></label>
                                        <input type="text" id="career_company_nm_1600236584" name="career_company_nm[]" value="" class="box_input" maxlength="80" data-api_type="auto" data-api_id="career_company" autocomplete="off">
                                        <p class="txt_error"></p>
                                    </div>
                                    <div class="area_check">
                                        <label for="career_comnm_open_fl_chk_1600236584" class="sri_check">
                                            <input type="checkbox" id="career_comnm_open_fl_chk_1600236584" name="career_comnm_open_fl_chk[]" class="inp_check" value="n">
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="area_period">
                                        <div class="resume_input">
                                            <input type="date" id="career_start_dt_1600236584" name="career_start_dt[]" class="expect_date box_input size_type2" value="" data-dateformat="yymm" data-only-number="true" autocomplete="off">
                                            <p class="txt_error"></p>
                                        </div>
                                        <span class="txt_period">~</span>
                                        <div class="resume_input">
                                            <input type="date" id="career_end_dt_1600236584" name="career_end_dt[]" class="expect_date box_input size_type2" value="" data-dateformat="yymm" data-only-number="true" autocomplete="off">
                                            <p class="txt_error"></p>
                                        </div>
                                        <div class="sri_select resume_select focus">
                                            <label for="career_retire_fl_1600236584" class="bar_title">재직구분<span class="valid_hidden">선택</span></label>
                                            <button class="ico_arr selected" type="button">퇴사</button>
                                            <input id="career_retire_fl_1600236584" name="career_retire_fl[]" type="hidden" value="y">
                                            <ul class="list_opt">
                                                <li class="on"><a class="link_opt" href="##" data-value="y">퇴사</a></li><li class=""><a class="link_opt" href="##" data-value="n">재직중</a></li>                </ul>
                                        </div>
                                        <p class="txt_error"></p>
                                    </div>
                                    <p class="info_period period_1600236584"></p>
                                </div>
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="resume_bundle">
                                        <div class="sri_select resume_select">
                                            <label for="career_retire_reason_sbox_1600236584" class="bar_title">퇴사사유<span class="valid_hidden"> 선택</span></label>
                                            <button class="ico_arr selected" type="button">퇴사사유 선택</button>
                                            <input type="hidden" id="career_retire_reason_sbox_1600236584" name="career_retire_reason_sbox[]" value="">
                                            <ul class="list_opt">
                                        ...
                                        <div class="resume_input" style="display:none">
                                            <label for="career_retire_reason_text_1600236584" class="bar_title">퇴사사유<span class="valid_hidden"> 직접입력</span></label>
                                            <input type="text" id="career_retire_reason_text_1600236584" name="career_retire_reason_text[]" class="box_input size_type4" value="" maxlength="20">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="resume_bundle">
                                        <div class="resume_input">
                                            <label for="career_job_grade_duties_1600236584" class="bar_title">직급/직책</label>
                                            <input type="text" id="career_job_grade_duties_1600236584" name="career_job_grade_duties[]" class="box_input max_length" value="" readonly="" data-api_type="layer" data-api_id="career_job_grade_duties" maxlength="20">
                                            <a href="javascript:void(0)" onclick="return false;" class="link_modifie">선택하기</a>
                                            <p class="txt_error"></p>
                                        </div>

                                        <div class="resume_input">
                                            <label for="career_year_1600236584" class="bar_title">년차<span class="valid_hidden"> 입력</span></label>
                                            <input type="text" id="career_year_1600236584" name="career_year[]" value="" class="box_input size_type2" maxlength="2" data-only-number="true">
                                        </div>
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="resume_input">
                                        <div class="option option_area">
                                            <label for="career_job_category_text_1600236584" class="bar_title">직종<span class="valid_hidden"> 선택</span></label>
                                            <input type="text" id="career_job_category_text_1600236584" name="career_job_category_text[]" value="" class="box_input" data-api_type="layer" data-api_id="career_job_category" data-dim="n" data-position="unused" readonly="">
                                            <p class="txt_error"></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="sri_select resume_select">
                                        <label for="career_area_cd_1600236584" class="bar_title">근무지역<span class="valid_hidden"> 선택</span></label>
                                        <button class="ico_arr selected" type="button">근무지역 선택</button>
                                        <input id="career_area_cd_1600236584" name="career_area_cd[]" type="hidden" value="">
                                        <ul class="list_opt">
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="resume_input">
                                        <label for="career_dept_nm_1600236584" class="bar_title">근무부서<span class="valid_hidden"> 입력</span></label>
                                ...
                                <div class="resume_row">
                                    ...
                                    <div class="area_salary">
                                        <div class="resume_input">
                                            <label for="career_salary_1600236584" class="bar_title">연봉<span class="valid_hidden"> 입력</span></label>
                                            <input type="text" id="career_salary_1600236584" name="career_salary[]" value="" class="box_input size_type3" maxlength="6" data-only-number="true">
                                        </div>

                                        <div class="sri_select resume_select focus">
                                            <label for="career_currency_1600236584" class="bar_title">원화구분</label>
                                            <button class="ico_arr selected size_type2" type="button">만원</button>
                                            <input id="career_currency_1600236584" name="career_currency[]" type="hidden" value="KRW">
                                            <ul class="list_opt">
                                        ...
                                        <p class="txt_error"></p>
                                        <p class="txt_number"></p></div>
                                </div>

                                <div class="resume_row">
                                    <div class="input_title">담당업무</div>
                                    <div class="resume_textarea">
                                        <label for="career_contents_1600236584" class="bar_title">담당업무<span class="valid_hidden"> 입력</span></label>
                                        <textarea id="career_contents_1600236584" name="career_contents[]" class="box_textarea"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="resume_project">
                                    <div class="area_title">
                                        ...
                                        <button class="btn_add btn_resume_add" type="button" data-tpl_id="tpl_career_project">프로젝트 수행이력 추가</button></div>


                                </div>
                                <div class="area_change_btn"></div></div>


                            <div class="area_resume_btn">
                                <button type="button" class="btn_resume_add" data-tpl_id="tpl_career_item">경력 추가</button>
                            </div></div>

                        <div id="career_total" style="display:none">
                            <div class="area_total_career">
                                <div class="resume_row">
                                    <div class="input_title">총 경력 <span class="point">필수</span></div>
                                    <div class="area_period">
                                        <div class="resume_input">
                                            <label for="career_period_year" class="bar_title"><span class="valid_hidden">총경력 년수</span><span class="blind">총경력 기간</span></label>
                                            <input type="text" id="career_period_year" name="career_period_year" class="box_input" value="" readonly="" maxlength="2" data-only-number="true">
                                        </div>
                                        <span class="txt_period">년</span>

                                        <div class="resume_input">
                                            <label for="career_period_month" class="bar_title"><span class="valid_hidden">총경력 월수</span><span class="blind">총경력 기간</span></label>
                                            <input type="text" id="career_period_month" name="career_period_month" class="box_input" value="" readonly="" maxlength="2" data-only-number="true">
                                        </div>
                                        <span class="txt_period">개월</span>

                                        <div class="area_check">
                                            <label class="sri_check" for="career_repetition_removal">
                                                <input type="checkbox" id="career_repetition_removal" name="career_repetition_removal" class="inp_check" value="y">
                                                <span class="txt_check">중복 기간 빼기</span>
                                            </label>
                                            <label class="sri_check" for="career_user_input">
                                                <input type="checkbox" id="career_user_input" name="career_user_input" class="inp_check" value="y">
                                                <span class="txt_check">직접입력</span>
                                            </label>
                                            <label class="sri_check" for="abroad_work_fl">
                                                <input type="checkbox" id="abroad_work_fl" name="abroad_work_fl" class="inp_check" value="y">
                            ...
                            <div class="core_competence">
                                <div class="resume_row">
                                    ...
                                    <div class="area_ability">
                                        <div class="resume_input">
                                            <label for="career_core_competence_contents_1" class="blind">핵심역량1</label>
                                            <input class="box_input size_type5" type="text" id="career_core_competence_contents_1" name="career_core_competence_contents[]" value="" maxlength="45" placeholder="핵심역량은 1개당 최대 45자까지 입력 가능합니다.">
                                            <p class="txt_error"></p>
                                        </div>
                                        <div class="resume_input">
                                            <label for="career_core_competence_contents_2" class="blind">핵심역량2</label>
                                            <input class="box_input size_type5" type="text" id="career_core_competence_contents_2" name="career_core_competence_contents[]" value="" maxlength="45" placeholder="핵심역량은 1개당 최대 45자까지 입력 가능합니다.">
                                            <p class="txt_error"></p>
                                        </div>
                                        <div class="resume_input">
                                            <label for="career_core_competence_contents_3" class="blind">핵심역량3</label>
                                            <input class="box_input size_type5" type="text" id="career_core_competence_contents_3" name="career_core_competence_contents[]" value="" maxlength="45" placeholder="핵심역량은 1개당 최대 45자까지 입력 가능합니다.">
                                            <p class="txt_error"></p>
                                        </div>
                                    </div>
                                </div>
                ...
                </div><div id="activity" class="resume_section" data-order_item="activity" data-except="y" style="display: none;">
                    <div class="area_title">
...
{*                        </div>*}
                ...
                <div id="license" class="resume_section" data-order_item="license" data-except="y" style="display: block;">
                    <div class="area_title">
                        <h3 class="title">자격증/어학/수상 내역</h3>

{*                        <div class="area_import_btn">*}
{*                            <button type="button" class="btn" data-api_type="layer" data-api_id="item_import" data-item="license">기본 정보 불러오기</button>*}
{*                        </div>*}
                    </div>

                    <div class="resume_write resume_write_add">

                        <div id="tpl_row_1600236584420" class="tpl_row" data-tpl_id="tpl_license">
                            <input type="hidden" id="merged_license_index_1600236584420" name="merged_license_index[]" value="license">
                            <input type="hidden" id="license_cd_1600236584420" name="license_cd[]" value="">
                            <input type="hidden" id="license_direct_1600236584420" name="license_direct[]" value="n">
                            <input type="hidden" id="license_obtain_dt_year_1600236584420" name="license_obtain_dt_year[]" value="">
                            <input type="hidden" id="license_obtain_dt_month_1600236584420" name="license_obtain_dt_month[]" value="">

                            <div class="resume_row">
                                <div class="input_title">항목선택</div>
                                <div class="sri_select resume_select focus">
                                    <label for="item_type_1600236584420" class="bar_title">항목선택</label>
                                    <button type="button" class="ico_arr selected">자격증/면허증</button>
                                    <input id="item_type_1600236584420" name="item_type[]" type="hidden" value="license">
                                    <ul class="list_opt">
                            ...
                            <div class="resume_row">
                                ...
                                <div class="resume_input">
                                    <label for="license_nm_1600236584420" class="bar_title">자격증명<span class="valid_hidden"> 입력</span></label>
                                    <input type="text" id="license_nm_1600236584420" name="license_nm[]" class="box_input" value="" maxlength="100" data-api_type="auto" data-api_id="license_nm" data-min_len="2" autocomplete="off">
                                    <p class="txt_error"></p>
                                </div>
                            </div>
                            ...
                            <div class="resume_row">
                                ...
                                <div class="resume_input">
                                    <label for="license_public_org_1600236584420" class="bar_title">발행처/기관<span class="valid_hidden"> 입력</span></label>
                                    <input type="text" id="license_public_org_1600236584420" name="license_public_org[]" class="box_input" value="" maxlength="150">
                                    <p class="txt_error"></p>
                                </div>
                            </div>
                            ...
                            <div class="resume_row">
                                ...
                                <div class="sri_select resume_select">
                                    <label for="license_level_1600236584420" class="bar_title">합격구분<span class="valid_hidden"> 선택</span></label>
                                    <button type="button" class="ico_arr selected">합격구분 선택</button>
                                    <input type="hidden" id="license_level_1600236584420" name="license_level[]" value="">
                                    <ul class="list_opt">
                            ...
                            <div class="resume_row">
                                ...
                                <div class="area_period">
                                    <div class="resume_input">
{*                                        <label for="license_obtain_dt_1600236584420" class="bar_title"><span class="valid_hidden">YYYYMM</span><span class="blind">취득일</span></label>*}
                                        <input type="date" id="license_obtain_dt_1600236584420" name="license_obtain_dt[]" class="expect_date box_input" value="" data-dateformat="yymm" data-only-number="true" autocomplete="off">
                                    </div>
                                    <p class="txt_error"></p>
                                </div>
                            </div>
                            <div class="area_change_btn"></div></div><div class="area_add_btn">
                            <button type="button" class="btn_resume_add" data-tpl_id="tpl_license_default"><span>자격증/어학/수상내역 추가</span></button>
                        </div>


                    </div>
                </div><div id="skill" class="resume_section" data-order_item="skill" data-except="y" style="display: block;">
                    <div class="area_title">
                            ...
                            <div class="resume_row">
                                ...
                                <div class="area_skill">
                                    <div class="resume_input search_input">
                                        <label for="s_ability_gb" class="bar_title">보유기술 입력 <span class="valid_hidden">(ex. 문서작성능력, 비즈니스영어, 커뮤니케이션스킬, java 등)</span></label>
                                        <input type="text" id="s_ability_gb" name="user_skill" class="box_input size_type5" maxlength="45" data-api_type="auto" data-api_id="skill" data-min_len="2" autocomplete="off">
...
{*                        </div>*}
                ...
                <div id="career_profile" class="resume_section" data-order_item="career_profile" data-except="y" style="display: block;">
                    <div class="area_title">
                        <h3 class="title">경력기술서</h3>

{*                        <div class="area_import_btn">*}
{*                            <button type="button" class="btn" data-api_type="layer" data-api_id="item_import" data-item="career_profile">기본 정보 불러오기</button>*}
{*                        </div>*}
                    </div>
                        ...
                        <div class="intro_item_wrap">
                            <div class="write_area" id="write_area">
                                <div class="inner_wrap">
                                    <div class="tpl_row intro_item" data-tpl_id="tpl_career_profile">
                                        <div class="item_txt">
                                            <div class="textarea_wrap">
                                                <label class="txt" for="career_profile">최근 경력부터 역순으로 작성하며, 주요업무 내용 단위로 본인의 역할과 객관적인 성과를 작성해보세요.<br>(업무 주요내용, 기간, 역할, 기여도, 성과 등을 작성하며 본인의 역량과 업무 능숙도를 어필해보세요.)</label>
                                                <textarea id="career_profile" name="user_career_con" class="textarea_type1" rows="1" cols="100" data-char-count="true" style="height: 240px;"></textarea>
                                            </div>
...
{*                                            </div>*}
                ...
                </div><div id="introduce" data-order_item="introduce" data-except="y" style="display: block;">
                                    ...
                                    <div id="tpl_row_1600236587" class="tpl_row intro_item on" data-tpl_id="tpl_introduce_item">
                                        <div class="item_title">
                                            <div class="input_wrap">
                                                <label for="intro_title_1600236587" class="txt">자소서 제목</label>
                                                <input type="text" id="intro_title_1600236587" name="user_info_sbj" class="input_type1" value="" maxlength="100">
                                                <p class="txt_error"></p>
                                            </div>
                                            <div class="area_change_btn"></div></div>
                                        ...
                                        <div class="item_txt">
                                            <div class="textarea_wrap">
                                                <label for="intro_contents_1600236587" class="txt">자소서 내용</label>
                                                <textarea id="intro_contents_1600236587" name="user_info_con" class="textarea_type1" rows="1" cols="100" data-char-count="true" style="height: 240px;"></textarea>
                                            </div>
...
{*                                    </div></div>*}
                ...
                <div class="area_btn tj_user">
                    <button type="button" class="btn_big_type btn_big_type2 btn_save">이력서 저장</button>
                    <button type="button" class="btn_big_type btn_preview">취소</button>
                </div>
            </form>
...
<script type="text/javascript" src="/pages/taxjob/taxjob/assets/js/taxjob.js" ></script>
