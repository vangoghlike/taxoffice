...
{ CONTENTS['head_contents'] }
					...
					<div class="viewWrap">
						...
						<div class="line">
							<div class="left">
								<div class="box">
									<div class="tit">유튜브</div>
									<div class="txt"><a href="{ DATA['youtube_link'] }" target="_blank">{ DATA['youtube_link'] }</a></div>
								</div>
							</div>
						</div>
						{ ? CONF['use_file_yn'] == 'Y' }
						<div class="line">
							<div class="left">
								<div class="box">
									...
									{ @ DATA['file'] }
										<div class="txt"><a href="#" class="btnDownload file-download" data-part="{ CONF['board_code'] }" data-encname="{ .file_name_saved }" data-filename="{ .file_name }">{ .icon }{ .file_name }</a></div>
									{ / }
								</div>
							</div>
						</div>
						...
						{ ? DATA['youtube_idno'] }
							<iframe id="ytplayer" width="1080" height="608" src="https://www.youtube.com/embed/{ DATA['youtube_idno'] }?rel=0&amp;&amp;wmode=transparent" wmode="Opaque"></iframe>
						{ / }
						</div>
