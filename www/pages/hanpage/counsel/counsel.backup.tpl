{ #header }
<!-- subTop -->
<div class="subTop company counsel">
    <div class="text"><strong>Tax Call Center</strong><!--&nbsp;&nbsp;<span>OnBiz Net</span>--></div>
</div>
<!-- //subTop -->
<!-- Wrap -->

<?php
    $counsel_type = $_GET['tp'];
    $counsel_txt = '예약';
    switch ($counsel_type) {
        case 'call': $counsel_txt = '전화(예약)상담'; break;
        case 'mail': $counsel_txt = '메일전송'; break;
        case 'visit': $counsel_txt = '방문예약'; break;
    }
?>
...
<div class="wrap counsel">
    ...
    <div class="subContainer">
        ...
        <div class="telTab">
            <?php if($counsel_type != 'visit'){ ?>
            <ul>
                <li{ ? STEP == '1' } class="active"{ / }><a>상담 세목 선택</a></li>
                <li{ ? STEP == '2' } class="active"{ / }><a>세무사 선정</a></li>
                <li{ ? STEP == '3' } class="active"{ / }><a><?php echo $counsel_txt; ?></a></li>
                <li class="helpTab"><a>세무상담 Hub</a></li>
            </ul>
            <?php }else{ ?>
            <ul class="fiveTab">
                <li{ ? STEP == '1' } class="active"{ / }><a>상담 세목 선택</a></li>
                <li{ ? STEP == '2' } class="active"{ / }><a>세무사 선정</a></li>
                <li{ ? STEP == '3' } class="active"{ / }><a>상담일정 선택</a></li>
                <li{ ? STEP == '4' } class="active"{ / }><a><?php echo $counsel_txt; ?></a></li>
                <li class="helpTab"><a>세무상담 Hub</a></li>
            </ul>
            <?php } ?>
        </div>
        ...
        <div class="hubPop">
            <a class="hubClose">닫기</a>
            <div class="ceoWrap">
                <div class="tit01"><span>OnBizTax TaxCallcenter</span> 방문을 환영합니다.</div>
                <div class="text">OnBizTax TaxCallcenter는 세무상담 전용 NetWork입니다.<br>
                TaxCallcenter에 세무상담을 주시면 NetWork 회원세무사님들이 바로 연결됩니다.<br>
                분야별로 등록된 NetWork 회원 세무사님들께 전화상담, 메일상담, 방문상담을 신청하실 수 있습니다.<br>
                OnBizTax TaxCallcenter의 상담규칙에 의하면 1차 전화 상담 및 메일상담은 무료이며,<br>
                그 외에 추가되는 상담 및 서류상담은 상담세무사님과 협의하여 보수를 정하여 의뢰하실 수 있습니다.<br>
                언제든지 편하게 이용해 보시기 바랍니다.<br>
                지금 바로 전화나 메일을 주시기 바랍니다.<br>
                더 중요한 사안이 있으시면 예약을 하시고 방문상담을 하실 수 있습니다.<br>
                언제든지 편하게 방문해 주세요.<br>
                감사합니다.<br><br>

                <strong>OnBizTax 상담세무사 일동</strong>
                    <br>
                </div>
            </div>
        </div>
        ...
        <div class="colBox3">
            ...
            <form id="frm_tax1" name="frm_tax1" method="post" >
                ...
                <div class="selectBtns">
                    <div class="select1 call">
                        <input type="radio" name="etc01" id="select1" value="전화상담" class="req" title="상담 방법을 선택해주세요." /> <label for="select1" class="call">전화상담</label>
                    </div>
                    <div class="select1 mail">
                        <input type="radio" name="etc01" id="select3" value="메일상담" class="req" title="상담 방법을 선택해주세요." /> <label for="select3" class="mail">메일상담</label>
                    </div>
                    <div class="select1 visit">
                        <input type="radio" name="etc01" id="select2" value="방문상담" class="req" title="상담 방법을 선택해주세요." /> <label for="select2" class="visit">방문상담</label>
                    </div>
                </div>
                <!--//선택버튼 추가-->
                <ul class="option category">
                    ...
                    <li data-idno="347" data-name="법인설립 및 자문"><button>법인설립 및 자문</button></li>
                </ul>
                <!--
                <div class="telSel">
                    <div id="select_box">
                    ...
                    <li class="actMb">
                        <div class="topInfo">
                            <div class="selView">
                                ...
                                <div class="txt">
                                    <div class="tit01"><a href="tel:{ REQ.mngr_tel }"><tag>{ REQ.category_name }</tag><br class="pcNo"> <b>즉시통화</b> <i class="fa fa-phone" aria-hidden="true"></i></a></div>
                                </div>
                            </div>
                            <div class="btn">
                    ...
                    <li>
                        <div class="topInfo">
                            <div class="selView">
                                ...
                                <div class="txt">
                                    <div class="tit01"><a class="counselGo" href="#goTalkPop"><tag>{ REQ.category_name }</tag><br class="pcNo"><b>상담예약</b> (예약후 30분내 전화 연결) <i class="fa fa-phone" aria-hidden="true"></i></a></div>
                                </div>
                            </div>
                            <div class="btn">
                                {*									<input type="radio" name="option" id="point{ .idno }" value="{ .idno }" data-name="{ .option_name }" /> <label for="point{ .idno }">선택</label>*}
        ...
        <div id="goTalkPop" class="goTalkPop">
            ...
            <form id="frm_counsel_talk" name="frm_counsel_talk" method="post" >
                ...
                <div class="gtp-wrap">
                    ...
                    <p><strong>신청자</strong><span><input type="text" class="req" name="name" value="{ USERINFO['user_name'] }" maxlength="20" title="휴대폰을 입력해주세요."/></span></p>
        ...
        <form id="frm_counsel" name="frm_tax_pay" method="post" >
            ...
            <input type="hidden" name="selimbiz" value="OnBizTax" />
            <input type="hidden" name="goods_name" value="메일상담" />
        ...
        <form id="frm_tax1" name="frm_tax1" method="post" >
            ...
            <div class="telSca">
                ...
                <div class="line dtBox seCst">
                    <label>
                        <img src="{ TYPE_URL }/images/counsel/bgTaxer.png"/>&nbsp;&nbsp;상담세무사 : { REQ.mngr_name }
                    </label>
                    <label>
                        <img src="{ TYPE_URL }/images/counsel/bgSort.png"/>&nbsp;&nbsp;상담세목 : { REQ.category_name }
                    </label>
                </div>

                <div class="line ipBox seCst">
                    <label for="seCst_date_field">
                        <img src="{ TYPE_URL }/images/counsel/bgTax13.png"/>&nbsp;&nbsp;예약날짜 선택
                    </label>
                ...
                <div class="line telSel seCst">
                    <label for="app_time">
                        <img src="{ TYPE_URL }/images/counsel/bgTimer.png"/>&nbsp;&nbsp;예약시간 선택
                    </label>
                    <div id="select_box">
                        <span>예약시간 선택하기</span>
...
{*        <div class="telTit pt30">*}
{*            <div class="tit01">상담 이용권 선택하기</div>*}
{*            <div class="tit02">통화 시간에 맞는 이용권을 선택해주세요.</div>*}
{*        </div>*}
...
{*                            <div class="selView">*}
{*                                <div class="img">*}
{*                                    <img src="{ TYPE_URL }/images/counsel/bgTax1{ .index_ }.png" alt="{ .option_name }">*}
{*                                </div>*}
{*                                <div class="txt">*}
{*                                    <div class="tit01">{ .option_name }</div>*}
{*                                    <div class="tit02">{ ? .price > 0 }{ =number_format(.price) }{ : }무료{ / }</div>*}
{*                                </div>*}
{*                            </div>*}
{*                            <div class="btn">*}
{*                                <input type="radio" name="option" id="point{ .idno }" value="{ .idno }" data-name="{ .option_name }" /> <label for="point{ .idno }">선택</label>*}
...
{*        </form>*}
        ...
        { ? STEP == '4' }
        <div class="telTit pt30 seCst">
            <div class="tit01">방문예약</div>
            <div class="tit02">예약 정보를 확인해주세요.</div>
        </div>
        <form id="frm_counsel" name="frm_tax_pay" method="post" >
            <input type="hidden" name="act" value="counsel_save" />
            <input type="hidden" name="status" value="0" />
            ...
            <input type="hidden" name="goods_name" value="방문상담" />
            <input type="hidden" name="selimbiz" value="OnBizTax" />
            <input type="hidden" name="category_idno" value="{ REQ.category }" />
            <input type="hidden" name="category_name" value="{ REQ.category_name }" />
            <input type="hidden" name="etc01" value="{ REQ.etc01 }" />
...
<div id="csl_login_form">
    <h2 class="csl_lform_hd">Onbiz Taxcallcenter User
