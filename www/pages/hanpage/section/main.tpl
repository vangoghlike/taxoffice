{ #header }
		...
		<div class="container" id="fullpage">
			...
			<!-- mainSlide -->
			<div class="mainSlide section active" id="section0">
				<div class="in">
					<ul>
					{ @ S_BANNER[1] }	
						<li>{ .contents }</li>
			...
			<!-- mainContent -->
			<div class="mainContent section" id="section1">
			...
			<!-- mainContent -->
			<div class="mainContent section" id="section2">
				<!-- mainTab -->
				<div class="mainTab">
