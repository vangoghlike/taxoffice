...
<link rel="stylesheet" type="text/css" href="{TYPE_URL}/css/common.css?v=20210820005"  media="all" />
...
{ / }
<script type="text/javascript" src="/common/js/common.js?v=20210826" ></script>
<script type="text/javascript" src="{TYPE_URL}/js/common.js?v=20210826" ></script>
...
<body class="{ ? MENU_ORD_NO == '0' }no_subtop{ / }">
	...
	<div class="wrap">
		...
		<div class="head">
			...
			<div class="topMenu">
				<div class="tmWrap">
					<ul class="sMenu">
						...
						<li>{ ? USERINFO['user_id'] }<a href="{ BASE_URL }/userinfo">MyPage</a>{ : }<a href="{ BASE_URL }/join">Join</a>{ / }</li>
			...
			<div class="topHead">
				<div class="h1Wrap">
					<h1><a href="{ BASE_URL }/{ HAN_PAGE_MAIN_URL }"><img src="{TYPE_URL}/images/common/{ HAN_LOGO_NAME }.png" alt="한페이지"></a></h1>
				</div>
...
{*							<li class="gnb_nav"><button type="button" class="gnb_menu_btn"><i class="fa fa-bars" aria-hidden="true"></i></button></li>*}
					...
					<div class="menu-btn__wrap { ? MENU_NO == '406' }on{ /}">
						{ ? HAN_LOGO_NAME == 'taxcall_logo' }
						<a class="menu-btn hp-btn" target="_self" href="http://www.han-page.co.kr/406">
						{ : }
...
{*					<li class="qna_li">*}
{*						{ ? USERINFO['user_auth'] == '["*"]' }*}
{*						<a href="http://www.han-page.co.kr/412">*}
{*							질문함*}
{*						</a>*}
{*						{ : }*}
{*						<a href="http://www.han-page.co.kr/411/485/write?">*}
{*							질문함*}
{*						</a>*}
{*						{ / }*}
{*					</li>*}
					<li class=""><a href="http://www.han-page.co.kr/406">한페이지 세무정보</a></li>
					<li class=""><a href="{ BASE_URL }/498">세림 Call Center</a></li>
					<li class=""><a href="{ BASE_URL }/506">신고도움 서비스</a></li>
					{ : }
{*					<li class="qna_li">*}
{*						{ ? USERINFO['user_auth'] == '["*"]' }*}
{*						<a href="{ BASE_URL }/412">*}
...
{*						{ / }*}
{*					</li>*}
					<li class=""><a href="{ BASE_URL }/406">한페이지 세무정보</a></li>
					<li class=""><a href="http://www.taxcallcenter.com/498">세림 Call Center</a></li>
					<li class=""><a href="http://www.taxcallcenter.com/506">신고도움 서비스</a></li>
					{ / }
