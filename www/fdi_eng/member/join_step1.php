...
<div class="subContent">
	...
	<!-- //subTopInfo -->
	<ol class="joinsubNav">
		<li class="on"><img src="/pages/default/images/sub/joinsubNav01.jpg" alt="약관동의 아이콘"><img class="on_img" src="/pages/default/images/sub/joinsubNav01_on.jpg" alt="약관동의 아이콘">Accept terms</li>
		<li><img src="/pages/default/images/sub/joinsubNav03.jpg" alt="회원정보입력 아이콘"><img class="on_img" src="/pages/default/images/sub/joinsubNav03_on.jpg" alt="회원정보입력 아이콘">Member Info</li>
		<li><img src="/pages/default/images/sub/joinsubNav04.jpg" alt="가입완료 아이콘"><img class="on_img" src="/pages/default/images/sub/joinsubNav04_on.jpg" alt="가입완료 아이콘">Signed up</li>
	</ol>
	<!-- contStart -->
	<div class="contStart">
		<form class="join_step1" id="frm_join1" name="frm_join1" method="post" action="">
			<div class="cont_wrap mb50">
				...
				<div class="agree_wrap">
					...
					<label for="agree1">I have read and agree to the Terms of Service.</label>
				</div>
			</div>
			<div class="cont_wrap">
			...
			<div class="btns_wrap mt30 pt25 text-center">
				<input class="join_blue_btn join_Btn mr10" style="cursor:pointer;" type="button" onclick="nextLevel()" value="I agree to all the terms">
