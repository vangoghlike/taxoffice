    ...
    <header>
        <div class="header_wrap">
            <div class="header_left">
                <h1 class="logo"><a href="/"><img src="/fdi_eng/pub/images/logo2.png" alt="selim"></a></h1>

                <div class="lang pc">
                    <a href="http://fdihelpcenter.co.kr/">KOR</a>
                    <a href="/fdi_eng/" class="on">ENG</a>
                </div>

                <div class="selim_link" style="padding:0 0.5rem; box-sizing: border-box; padding:0 0.125rem; height:1.25rem; margin-right:0.25rem;">
                    <a href="http://www.etaxoffice.co.kr/eng/" class="hd_sub_link">
                        <img class="logo_img" src="/fdi_eng/pub/images/logo_txt.png" alt="selim logo"/>
                    </a>
                </div>
                <div class="family_link" style="padding:0 0.5rem; box-sizing: border-box; padding:0 0.125rem; height:1.25rem;">
                    <a href="http://www.etaxoffice.co.kr/eng/sub/?cat_no=85" class="hd_sub_link">
            ...
            <div class="header_right">
				...
				<?if($_SESSION[$_SITE["DOMAIN"]]["MEMBER"]["ID"] != ""){?>
                    <a href="/module/member/eng_logout.php">Logout</a>
                    <a href="/fdi_eng/mypage/user_info.php">MyPage</a>
				<?}else{?>
					<a href="/fdi_eng/member/login.php">Login</a>
                    <a href="/fdi_eng/member/join_step1.php">Register</a>
				<?}?>
                </div>
            </div>
        </div>
                ...
                <ul class="gnb_main">
                    ...
                    for($i=0;$i<$arrMenu['one']['total'];$i++){
                        if($arrMenu['one'][$i]['show']=="Y"){
                            ...
                            echo '<a class="pc_vw '.$sel_class.'" href="/fdi_eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
                            ...
                            for($j=0;$j<$arrMenu['two'][$tcode]['total'];$j++){
                                if($arrMenu['two'][$tcode][$j]['show'] == "Y"){
                                    if ( $arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']] == '87' ) {
                                        switch(date('n')) {
                                            case '1':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=87">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '2':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=88">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '3':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=89">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '4':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=90">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '5':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=91">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '6':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=92">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '7':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=93">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '8':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=94">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '9':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=95">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '10':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=96">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '11':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=97">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            case '12':
                                                echo '<li><a href="/fdi_eng/sub/?cat_no=98">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                            default:
                                                echo '<li><a href="/fdi_eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                                break;
                                        }
                                    } else {
                                        echo '<li><a href="/fdi_eng/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
