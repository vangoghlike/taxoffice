...
<script>
	...
	location.href = "/fdicenter/member/login.php";
</script>
<?}else{?>
    ...
    <div class="contStart">
        <form class="joinStep3" id="frm_join2" name="frm_join2" method="post" action="/module/member/member_evn.php" onsubmit="frmchk(document.frm_join2)">
            ...
            <div class="btns_wrap mt30 pt25 text-center borer-none">
                ...
                <div style="float:right"><button class="join_black_btn join_Btn" type="button" onclick="location.href='/fdicenter/mypage/leave.php'">Withdrawal</button></div>
            </div>
        </form>
    </div>
    <!-- //contStart -->
