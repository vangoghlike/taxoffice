...
<script>
    ...
    <form id="frm_counsel" name="frm_counsel" action="/module/mail/mail_evn.php" method="post">
        ...
        <input type="hidden" name="goods_idno" value="">
        <input type="hidden" name="tax_nick" value="세림세무법인">
        <input type="hidden" name="goods_name" value="[상담]메일상담">
        <input type="hidden" name="category" value="">
        <input type="hidden" name="etc01" value="메일상담">
        <input type="hidden" name="mngr_idno" value="4">
        <input type="hidden" name="manager" value="권다희 세무사">
        <input type="hidden" name="mngr_name" value="권다희 세무사">
        <input type="hidden" name="mngr_phone" value="010-8487-4005">
        <input type="hidden" name="mngr_mail" value="">
        <input type="hidden" name="option_idno" value="">
        ...
        <div class="telSca mailList">
            <div class="userInfoZone">
                ...
                <p>
                    ...
                    <span><input type="text" class="req" name="user_name" value="홈관리자" maxlength="25" title="이름을 입력해주세요."></span>
                </p>
                <p>
