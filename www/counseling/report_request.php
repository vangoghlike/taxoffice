...
<style>
	...
	<div class="telTit pt30">
		...
		<div class="tit02">신고의뢰 상담을 원하는 세무사를 선택하여 주세요.
            <div class="tit03">세무 상담시 수수료가 발생할 수 있습니다.</div></div>
	</div>
	...
	<div id="goTalkPop" class="goTalkPop">
		...
		<form id="frm_counsel_talk" name="frm_counsel_talk" method="post">
			...
			<div class="gtp-wrap">
				...
				<p><strong>신청자명</strong><span><input type="text" required="required" class="req" name="name" value="" maxlength="20" title="신청자명을 입력해주세요." /></span></p>
                <p><strong>내 핸드폰</strong><span>
                        <input type="tel" class="req" name="u_phone" required="required" value="" placeholder="예) 010-1234-5678" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" maxlength="13"/>
                    </span></p>
			</div>
