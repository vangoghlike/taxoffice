...
<script src="/common/js/calc.js"></script>
    ...
    <div class="subContainer myTax mt02" id="se_calc">
        ...
        <div>
            ...
            <div class="lh24">
                ...
                <label class="lh24">양도일자 &nbsp;<input class="ip05 selim-date" type="text" readonly="" value="2021-11-26"></label><br>
                <label class="lh24 last">취득일자 &nbsp;<input class="ip06 selim-date" type="text" readonly="" value="2021-11-26"></label>
            </div>
