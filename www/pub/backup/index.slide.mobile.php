        ...
        <div class="v_slide">
            <div class="swiper-wrapper">
                <div class="swiper-slide notice_wrap">
                    <a class="view_area" href="/sub/index.php?cat_no=221&boardid=revisedtaxlaw&mode=view&idx=22&sk=&sw=&offset=&category=">
                        <div class="inner">
                            <p class="empha">
                                2023년부터 이렇게 달라집니다.
                            </p>
                            <p>
                                2023년부터 달라지는 주요 개정사항 확인하세요.<br>
                                <!--                                        (2023.01.01. 정부발간책자 일부 발췌)<br><br>-->
                                (2023.01.01. 기획재정부 자료 일부 발췌)<br><br>
                                사업관련제세 (법인세,소득세)
                            </p>
            ...
            <div class="v_btn_wrap">
                <div class="v_btn">
                    ...
                    <div class="slide_num">
                        ...
                        <div class="num all" id="all_number">0<?=($bannerTotal+1)?></div>
                    </div>
