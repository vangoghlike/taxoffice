                ...
                <div class="swiper-wrap">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide"><!-- slide 0 -->
                            <a class="view_area" href="/sub/index.php?cat_no=308&boardid=taxInfo_stock&mode=view&idx=519&sk=&sw=&offset=&category=">
                                <div class="inner">
                                    <p class="empha">
                                        다주택자 양도소득세 중과 규정 안내 (예정)
                                    </p>
                                    <p>
                                        (1) 양도세 중과 적용 시 세율 비교<br/>
                                        (2) 다주택 중과대상 여부 판단 순서<br/>
                                        (3) 중과배제 장기임대주택<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/index.php?cat_no=308&boardid=taxInfo_stock&mode=view&idx=519&sk=&sw=&offset=&category=">
                                자세히 보기
                            </a>
                        ...
                        <div class="swiper-slide"><!-- slide 1 -->
                            <a class="view_area" href="/sub/?cat_no=342">
                                <div class="inner">
                                    <p class="empha">
                                        외국인의 국내 부동산취득절차
                                    </p>
                                    <p>
                                        1. 외국인이 국내 부동산을 취득하는 절차<br/>
                                        2. 취득, 보유, 양도 단계별 세금<br/>
                                        3. 등기 절차<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/?cat_no=342">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 2 -->
                            <a class="view_area" href="/sub/?cat_no=341">
                                <div class="inner">
                                    <p class="empha">
                                       1세대 1주택 비과세 판단
                                    </p>
                                    <p>
                                        - 1세대 여부 판단<br/>
                                        - 1주택의 판단<br/>
                                        - 1세대 1주택 비과세를 적용받기 위한 요건<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/?cat_no=341">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 4 -->
                            <a class="view_area" href="/sub/?cat_no=330">
                                <div class="inner">
                                    <p class="empha">
                                        외국인투자(FDI)에 대한 Process별 업무안내
                                    </p>
                                    <p>
                                        - FDI One Stop Service<br/>
                                        - FDI Process별 지원 내용<br/>
                                        &nbsp;<br/>
                                        &nbsp;<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/?cat_no=330">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 5 -->
                            <a class="view_area" href="https://www.taxoffice.co.kr/sub/?cat_no=277">
                                <div class="inner">
                                    <p class="empha">
                                        외국법인 국내지사 설치, 우선 확인할 사항
                                    </p>
                                    <p>
                                        Step1. 은행에 지사설치 신고<br/>
                                        Step2. 등기소에 지사설치 등기<br/>
                                        Step3. 세무서 사업자등록 신청<br/>
                                        <br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="https://www.taxoffice.co.kr/sub/?cat_no=277">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 6 -->
                            <a class="view_area" href="/sub/index.php?cat_no=150&boardid=taxspecial&mode=view&idx=214&sk=&sw=&offset=&category=">
                                <div class="inner">
                                    <p class="empha">
                                        기업 공제감면 및 세제 지원제도 안내
                                    </p>
                                    <p>
                                        - 중소기업 특별세액감면 (조특법 제7조)<br/>
                                        - 연구인력개발 세액공제 (조특법 제10조)<br/>
                                        - 창업중소기업 세액감면 (조특법 제6조)<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/index.php?cat_no=150&boardid=taxspecial&mode=view&idx=214&sk=&sw=&offset=&category=">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 7 -->
                            <a class="view_area" href="/sub/?cat_no=225">
                                <div class="inner">
                                    <p class="empha">
                                        연구소(연구전담부서) 설치 안내
                                    </p>
                                    <p>
                                        - 연구인력개발비 세액공제<br/>
                                        - 연구인력개발비 세액공제 신청 전 선행업무<br/>
                                        - 연구소나 연구전담부서 설치 및 신고 순서<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/?cat_no=225">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
                        ...
                        <div class="swiper-slide"><!-- slide 8 -->
                            <a class="view_area" href="/sub/?cat_no=340">
                                <div class="inner">
                                    <p class="empha">
                                        주식양도세율
                                    </p>
                                    <p>
                                        - 비상장 법인의 주식<br/>
                                        - 상장(거래소 및 협회등록법인)법인의 주식<br/>
                                        - 대주주의 범위(소득세법 시행령 제157조, 제167조의 8)<br/>
                                        이어서 보기..<br/>
                                    </p>
                                </div>
                            </a><br><br>
                            <a class="more_btn" href="/sub/?cat_no=340">
                                자세히 보기
                            </a>
                            <img class="absol_img" src="/pub/images/main/budget.png" alt="이미지"/>
                        </div>
...
<!--                        </div>-->
        ...
        <div class="v_quick content_wrap">
            <div class="q_slide q_pc pc_view">
                ...
                <a href="/sub/?cat_no=349" class="q1">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
                        <span>업무 도구</span>
                    </div>
                ...
                <a href="/sub/?cat_no=381" class="pc_view q6">
                    <div class="ir_pm q_img"></div>
                    <div class="q_txt">
