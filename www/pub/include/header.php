...
for($i=0;$i<$arrMenuList["total"];$i++){
    ...
    if($arrMenuList["list"][$i]["cat_depth"]==4){	## Depth 5
        ...
        $arrMenu['fiv'][$pcode][$di[$pcode]]['type']	= $arrMenuList["list"][$i]["cat_use_type"]; // 타입을 기억하기 위함 // /sub/index 에서 사용
    ...
    <header>
        <div class="header_wrap">
            <div class="header_left">
                <h1 class="logo"><a href="/"><img src="/pub/images/logo2.png" alt="세림세무법인"></a></h1>

                <div class="lang pc">
                    <a href="/" class="on">KOR</a>
                    <a href="http://etaxoffice.co.kr">ENG</a>
                </div>

                <div class="family_link" style="padding:0 0.5rem; box-sizing: border-box; padding:0 0.125rem; height:1.25rem; margin-right:0.5rem; min-width:5.75rem;">
            ...
            <div class="content_wrap">
				...
				for($i=0;$i<$arrMenu['one']['total'];$i++){
					if($arrMenu['one'][$i]['show']=="Y"){
						...
						echo '<li class="hdmenu'.$i.'"><div class="menu_wrap">';
						echo '<a class="pc_vw '.$sel_class.'" href="/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['one'][$i]['code']].'">'.$arrMenu['one'][$i]['name'].'</a>';
						...
						for($j=0;$j<$arrMenu['two'][$tcode]['total'];$j++){
							if($arrMenu['two'][$tcode][$j]['show'] == "Y"){
                                if ( $arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']] == '87' ) {
                                    switch(date('n')) {
                                        case '1':
                                            echo '<li><a href="/sub/?cat_no=87">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '2':
                                            echo '<li><a href="/sub/?cat_no=88">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '3':
                                            echo '<li><a href="/sub/?cat_no=89">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '4':
                                            echo '<li><a href="/sub/?cat_no=90">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '5':
                                            echo '<li><a href="/sub/?cat_no=91">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '6':
                                            echo '<li><a href="/sub/?cat_no=92">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '7':
                                            echo '<li><a href="/sub/?cat_no=93">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '8':
                                            echo '<li><a href="/sub/?cat_no=94">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '9':
                                            echo '<li><a href="/sub/?cat_no=95">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '10':
                                            echo '<li><a href="/sub/?cat_no=96">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '11':
                                            echo '<li><a href="/sub/?cat_no=97">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        case '12':
                                            echo '<li><a href="/sub/?cat_no=98">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                        default:
                                            echo '<li><a href="/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                            break;
                                    }
                                } else if ( $arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']] == '339' ) {
                                    echo '<li class="link-btn"><a href="https://semugpt.co.kr/" target="_blank" rel="noopener" data-skip-on="1">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                } else {
                                    echo '<li><a href="/sub/?cat_no='.$arrMenu['catLink'][$arrMenu['two'][$tcode][$j]['code']].'">'.$arrMenu['two'][$tcode][$j]['name'].'</a></li>';
                                }
							}
...
<!--				<li><a href="/sub/?cat_no=77">상담센터</a></li>-->
				<li><a href="/sub/?cat_no=124">회사설립지원</a></li>
				<li><a href="/sub/?cat_no=330">외국인투자기업</a></li>
				<li class="mo_case_menu">
					<a href="#">Topic별 세무</a>
					<ul class="family_sbox">
						<li><a href="/sub/?cat_no=207">Topic별 세무</a></li>
						<li><a href="/sub/?cat_no=162">벤처·스타트업</a></li>
					</ul>
				</li>
                <li><a href="/sub/?cat_no=41">업종별 세무</a></li>
                <li><a href="/sub/?cat_no=72">세림마당</a></li>
			</ul>
        </nav>
    </header>
    <!-- header end -->