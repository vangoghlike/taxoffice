    ...
    <footer>
        ...
        <div class="footer_customer">
            <div class="content_wrap">
                ...
                <div class="customer_right">
                    <a href="/sub/?cat_no=77">세무상담<br/><span>바로가기</span></a>
                    <a href="/sub/?cat_no=172">신고 도움<br/><span>바로가기</span></a>
                    <a href="/sub/?cat_no=21">한페이지 <br class="print_br"/>세무상담<br/><span>바로가기</span></a><?//   원래주소:  /sub/onepage.php?>
                    <a href="/sub/?cat_no=102">업무의뢰<br/><span>바로가기</span></a>
                </div>
            </div>
        </div>
        <div class="footer_bottom">
            <div class="f_btm_top">
                <div class="content_wrap">
                    <ul class="footer_nav">
                        <li><a href="/sub/?cat_no=66">법인소개</a></li>
                        <li><a href="/sub/?cat_no=76">소통 마당</a></li>
                        <li><a href="/sub/policy.php">개인정보처리방침</a></li>
                        <li><a href="/sub/agree.php">이용약관</a></li>
                        <li class="mo_footer"><a href="/sub/tax4.php">보수결제</a></li>
                        <li class="mo_footer"><a href="/mypage/pay.php">내 결제정보</a></li>
                        <li><a href="/sub/report.php">홈페이지 오류 신고</a></li>
                    </ul>
...
<!--							<a href="http://www.taxcall.co.kr/taxcall/sub/?cat_no=4"><li>한페이지</li></a>-->
    ...
    <nav class="aside">
        ...
        <ul>
            <li class="pc1112"><a href="/sub/?cat_no=77"><img src="/pub/images/quick_btn1.png" alt="세무상담"><br><span>세무상담</span></a></li>
            <li class="pc1112"><a href="/sub/?cat_no=172"><img src="/pub/images/quick_btn3.png" alt="신고도움센터"><br><span>신고 도움</span></a></li>
            <li class="pc1112"><a style="cursor:pointer;" href="/sub/?cat_no=21"><img src="/pub/images/quick_btn2.png" alt="한페이지"><br><span>한페이지<br>세무정보</span></a></li><?///주소 : /sub/onepage.php?>
            <li class="pc1112"><a href="/sub/?cat_no=102"><img src="/pub/images/mo_quick.png" alt="업무의뢰"><br><span>업무의뢰</span></a></li>
